#!/usr/bin/env bash
#
# Downloads a Rsil snapshot from a MinIO manifest into the schelk scratch volume
...
: "${BENCH_RSIL_BINARY:?BENCH_RSIL_BINARY must be set}"
