...
TARGET_METRIC_BLOCK_HEIGHT_QUERY = "rsil_blockchain_tree_canonical_chain_height"
...
def main():
    ...
    parser.add_argument(
        "--repo", default="sila-chain/sila-rsil", help="GitHub repo (owner/name)"
    )
