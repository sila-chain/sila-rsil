...
//   BENCH_BASELINE_ARGS    – Extra CLI args for the baseline rsil node
//   BENCH_FEATURE_ARGS     – Extra CLI args for the feature rsil node
...
function buildSuccessBlocks({
  ...
  const repoLink = `<https://github.com/${repo}|Rsil>`;
