...
#[derive(Debug)]
struct ChainInfoInner<N: NodePrimitives = rsil_sila_primitives::SilPrimitives> {
...
mod tests {
    ...
    use rsil_testing_utils::{generators, generators::random_header};
    ...
    fn test_chain_info() {
        ...
        let tracker: ChainInfoTracker<SilPrimitives> =
    ...
    fn test_on_forkchoice_update_received() {
        ...
        // Create a new chain info tracker with the header
        let tracker: ChainInfoTracker<SilPrimitives> = ChainInfoTracker::new(header, None, None);
    ...
    fn test_set_canonical_head() {
        ...
        let tracker: ChainInfoTracker<SilPrimitives> = ChainInfoTracker::new(header1, None, None);
