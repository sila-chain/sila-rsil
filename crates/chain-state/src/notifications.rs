...
pub type CanonStateNotifications<N = rsil_sila_primitives::SilPrimitives> =
    broadcast::Receiver<CanonStateNotification<N>>;

/// Type alias for a sender that sends [`CanonStateNotification`]
pub type CanonStateNotificationSender<N = rsil_sila_primitives::SilPrimitives> =
...
pub enum CanonStateNotification<N: NodePrimitives = rsil_sila_primitives::SilPrimitives> {
