...
use rsil_db::{mdbx::DatabaseArguments, open_db_read_only, tables, Database};
use rsil_db_api::transaction::DbTx;
use rsil_primitives_traits::FastInstant as Instant;
use rsil_stages_types::StageId;
use rsil_static_file_types::DEFAULT_BLOCKS_PER_STATIC_FILE;
...
impl SnapshotManifestCommand {
    ...
    pub fn execute(self) -> Result<()> {
        ...
        rsil_fs_util::write(&output, &json)?;
        info!(target: "rsil::cli",
            path = ?output,
