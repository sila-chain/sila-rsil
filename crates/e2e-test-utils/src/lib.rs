...
pub async fn setup_engine<N>(
    ...
    chain_spec: Arc<N::ChainSpec>,
    is_dev: bool,
    tree_config: rsil_node_api::TreeConfig,
    attributes_generator: impl Fn(u64) -> <<N as NodeTypes>::Payload as PayloadTypes>::PayloadAttributes
        + Send
        + Sync
        + Copy
