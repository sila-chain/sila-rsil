...
use rsil_node_api::{Block, BlockBody, BlockTy, FullNodeComponents, PayloadTypes, PrimitivesTy};
use rsil_node_builder::{rpc::RsilRpcAddOns, FullNode, NodeTypes};
    ...
    AddOns: RsilRpcAddOns<Node>,
{
    ...
    pub rpc: RpcTestContext<Node, AddOns::SilApi>,
...
where
    ...
    Node: FullNodeComponents,
    Node::Types: NodeTypes<ChainSpec: SilaHardforks, Payload = Payload>,
    ...
    AddOns: RsilRpcAddOns<Node>,
{
    ...
    where
        AddOns::SilApi: SilApiSpec<Provider: BlockReader<Block = BlockTy<Node::Types>>>
            + SilTransactions
            + TraceExt,
    {
