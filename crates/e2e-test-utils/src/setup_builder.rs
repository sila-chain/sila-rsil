...
use rsil_primitives_traits::AlloyBlockHeader;
use rsil_provider::providers::BlockchainProvider;
...
type TreeConfigModifier =
    Box<dyn Fn(rsil_node_api::TreeConfig) -> rsil_node_api::TreeConfig + Send + Sync>;
        ...
        + 'static,
{
    ...
    where
        G: Fn(rsil_node_api::TreeConfig) -> rsil_node_api::TreeConfig + Send + Sync + 'static,
    {
    ...
    pub fn with_pruning(self, pruning: rsil_node_core::args::PruningArgs) -> Self {
    ...
    pub async fn build(
        ...
        let base_tree_config =
            rsil_node_api::TreeConfig::default().with_cross_block_cache_size(1024 * 1024);
