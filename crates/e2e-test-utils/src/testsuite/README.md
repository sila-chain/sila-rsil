...
This directory contains the framework for writing end-to-end (e2e) tests in Rsil. The framework provides utilities for setting up test environments, performing actions, and verifying blockchain behavior.
...
```rust
use rsil_e2e_test_utils::{setup_import, Environment, TestBuilder};
...
This section provides comprehensive documentation for all available end-to-end (e2e) test actions in the Rsil testing framework. These actions enable developers to write complex blockchain integration tests by performing operations and making assertions in a single step.
...
```rust
use rsil_e2e_test_utils::testsuite::actions::AssertMineBlock;
...
```rust
use rsil_e2e_test_utils::testsuite::actions::ProduceBlocks;
...
```rust
use rsil_e2e_test_utils::testsuite::actions::ProduceBlocksLocally;
...
```rust
use rsil_e2e_test_utils::testsuite::actions::ProduceInvalidBlocks;
...
```rust
use rsil_e2e_test_utils::testsuite::actions::PickNextBlockProducer;
...
```rust
use rsil_e2e_test_utils::testsuite::actions::GeneratePayloadAttributes;
...
```rust
use rsil_e2e_test_utils::testsuite::actions::GenerateNextPayload;
...
```rust
use rsil_e2e_test_utils::testsuite::actions::BroadcastLatestForkchoice;
...
```rust
use rsil_e2e_test_utils::testsuite::actions::BroadcastNextNewPayload;
...
```rust
use rsil_e2e_test_utils::testsuite::actions::CheckPayloadAccepted;
...
```rust
use rsil_e2e_test_utils::testsuite::actions::UpdateBlockInfo;
...
```rust
use rsil_e2e_test_utils::testsuite::actions::UpdateBlockInfoToLatestPayload;
...
```rust
use rsil_e2e_test_utils::testsuite::actions::MakeCanonical;
...
```rust
use rsil_e2e_test_utils::testsuite::actions::CaptureBlock;
...
```rust
use rsil_e2e_test_utils::testsuite::actions::CreateFork;
...
```rust
use rsil_e2e_test_utils::testsuite::actions::SetForkBase;
...
```rust
use rsil_e2e_test_utils::testsuite::actions::SetForkBaseFromBlockInfo;
...
```rust
use rsil_e2e_test_utils::testsuite::actions::ValidateFork;
...
```rust
use rsil_e2e_test_utils::testsuite::actions::ReorgTo;
...
```rust
use rsil_e2e_test_utils::testsuite::actions::SetReorgTarget;
...
```rust
use rsil_e2e_test_utils::testsuite::actions::SelectActiveNode;
...
```rust
use rsil_e2e_test_utils::testsuite::actions::CompareNodeChainTips;
...
```rust
use rsil_e2e_test_utils::testsuite::actions::CaptureBlockOnNode;
...
```rust
use rsil_e2e_test_utils::testsuite::actions::ValidateBlockTag;
...
```rust
use rsil_e2e_test_utils::testsuite::actions::WaitForSync;
...
```rust
use rsil_e2e_test_utils::testsuite::actions::AssertChainTip;
...
```rust
use rsil_e2e_test_utils::testsuite::actions::{SendNewPayload, ExpectedPayloadStatus};
...
```rust
use rsil_e2e_test_utils::testsuite::actions::SendNewPayloads;
...
```rust
use rsil_rpc_e2e_tests::rpc_compat::RunRpcCompatTests;
...
```rust
use rsil_rpc_e2e_tests::rpc_compat::InitializeFromExecutionApis;
...
```rust
use rsil_e2e_test_utils::testsuite::actions::{SendForkchoiceUpdate, BlockReference};
...
```rust
use rsil_e2e_test_utils::testsuite::actions::FinalizeBlock;
...
```rust
use rsil_e2e_test_utils::testsuite::actions::TestFcuToTag;
...
```rust
use rsil_e2e_test_utils::testsuite::actions::ExpectFcuStatus;
...
```rust
use rsil_e2e_test_utils::testsuite::actions::ValidateCanonicalTag;
...
```rust
use rsil_e2e_test_utils::testsuite::actions::BlockReference;
...
```rust
use rsil_e2e_test_utils::testsuite::actions::ForkBase;
...
```rust
use rsil_e2e_test_utils::testsuite::actions::ReorgTarget;
...
```rust
use rsil_e2e_test_utils::testsuite::actions::ExpectedPayloadStatus;
...
use rsil_rpc_e2e_tests::rpc_compat::{InitializeFromExecutionApis, RunRpcCompatTests};
