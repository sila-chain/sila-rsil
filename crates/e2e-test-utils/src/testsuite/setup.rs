    ...
    I: EngineTypes,
{
    ...
    pub fn with_state(mut self, state: SavmState) -> Self {
    ...
    /// Create nodes with imported chain data
    ///
    /// Note: Currently this only supports `SilaNode` due to the import process
    /// being Sila-specific. The generic parameter N is kept for consistency
