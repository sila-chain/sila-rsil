...
use rsil_db::tables;
use rsil_e2e_test_utils::{transaction::TransactionTestContext, wallet, E2ETestSetupBuilder};
...
async fn test_rocksdb_node_startup() -> Result<()> {
    ...
    let (nodes, _wallet) =
        E2ETestSetupBuilder::<SilaNode, _>::new(1, chain_spec, test_attributes_generator)
            .with_storage_v2()
            .build()
            .await?;
...
/// <https://github.com/sila-chain/sila-rsil/pull/23081>.
///
