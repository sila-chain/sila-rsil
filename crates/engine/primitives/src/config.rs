...
/// Default number of reserved CPU cores for non-rsil processes.
///
/// This will be deducted from the thread count of main rsil global threadpool.
...
pub struct TreeConfig {
    ...
    /// Number of reserved CPU cores for non-rsil processes
    ...
    /// See: <https://github.com/sila-chain/execution-apis/blob/main/src/engine/paris.md#engine_forkchoiceupdatedv1> (Rule 2)
    ///
    ...
    /// Whether to disable BAL (Block Access List, SIP-7928) based parallel execution.
...
impl TreeConfig {
    ...
    /// Return the number of reserved CPU cores for non-rsil processes
    ...
    /// Setter for the number of reserved CPU cores for any non-rsil processes
