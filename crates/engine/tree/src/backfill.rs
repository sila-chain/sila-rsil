...
use rsil_provider::providers::ProviderNodeTypes;
use rsil_stages_api::{ControlFlow, Pipeline, PipelineError, PipelineTarget, PipelineWithResult};
...
mod tests {
    ...
    use rsil_provider::test_utils::MockNodeTypesWithDB;
    use rsil_stages::ExecOutput;
    use rsil_stages_api::StageCheckpoint;
    use rsil_tasks::Runtime;
        ...
        fn new(total_blocks: usize, pipeline_done_after: u64) -> Self {
            let chain_spec = Arc::new(
                ChainSpecBuilder::default()
                    ...
                    .genesis(SILA_MAINNET.genesis.clone())
                    .paris_activated()
                    .build(),
            );
