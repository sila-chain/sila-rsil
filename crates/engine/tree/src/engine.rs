...
pub enum EngineApiKind {
    /// The chain contains Sila configuration.
    #[default]
    Sila,
...
impl EngineApiKind {
    /// Returns true if this is the sila variant
    pub const fn is_sila(&self) -> bool {
        matches!(self, Self::Sila)
    }
...
#[derive(Debug)]
pub enum EngineApiEvent<N: NodePrimitives = SilPrimitives> {
