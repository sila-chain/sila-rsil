...
use rsil_primitives_traits::{constants::gas_units::MEGAGAS, FastInstant as Instant};
...
pub struct EngineApiMetrics {
    ...
    /// Metrics for SIP-7928 Block-Level Access Lists (BAL).
    #[allow(dead_code)]
...
pub(crate) struct ExecutionGasBucketSeries {
    /// Gas-bucketed SAVM execution duration.
...
/// Metrics for SIP-7928 Block-Level Access Lists (BAL).
///
/// See also <https://github.com/sila-chain/execution-metrics/issues/5>
#[allow(dead_code)]
