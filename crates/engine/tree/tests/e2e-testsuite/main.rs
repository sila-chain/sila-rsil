...
fn v2_engine_tree_setup() -> Setup<SilEngineTypes> {
...
async fn test_engine_tree_fcu_canon_chain_insertion_e2e() -> Result<()> {
    ...
    let test = TestBuilder::new()
        ...
        // produce one block
        .with_action(ProduceBlocks::<SilEngineTypes>::new(1))
        // make it canonical via forkchoice update
        .with_action(MakeCanonical::new())
        // extend with 3 more blocks
        .with_action(ProduceBlocks::<SilEngineTypes>::new(3))
...
async fn test_engine_tree_valid_forks_with_older_canonical_head_e2e() -> Result<()> {
    ...
    let test = TestBuilder::new()
        ...
        .with_action(ReorgTo::<SilEngineTypes>::new_from_tag("old_head"))
        // create first competing chain (chain A) from fork point with 10 blocks
        .with_action(CreateFork::<SilEngineTypes>::new_from_tag("fork_point", 10))
        ...
        .with_action(ReorgTo::<SilEngineTypes>::new_from_tag("chain_b_tip"));
...
async fn test_engine_tree_valid_and_invalid_forks_with_older_canonical_head_e2e() -> Result<()> {
    ...
    let test = TestBuilder::new()
        ...
        // scenario
        .with_action(ReorgTo::<SilEngineTypes>::new_from_tag("fork_point"))
        ...
        .with_action(ProduceInvalidBlocks::<SilEngineTypes>::with_invalid_at(3, 2))
...
async fn test_engine_tree_reorg_with_missing_ancestor_expecting_valid_e2e() -> Result<()> {
    ...
    let test = TestBuilder::new()
        ...
        .with_action(ProduceBlocks::<SilEngineTypes>::new(6))
        .with_action(MakeCanonical::new())
        .with_action(CaptureBlock::new("main_chain_tip"))
        // create a valid fork first
        .with_action(CreateFork::<SilEngineTypes>::new_from_tag("main_chain_tip", 5))
    ...
    let invalid_test = TestBuilder::new()
        ...
        .with_action(ProduceInvalidBlocks::<SilEngineTypes>::with_invalid_at(2, 0));

    assert!(invalid_test.run::<SilaNode>().await.is_err());
...
async fn test_engine_tree_buffered_blocks_are_eventually_connected_e2e() -> Result<()> {
    ...
    let test = TestBuilder::new()
        ...
        .with_action(ProduceBlocksLocally::<SilEngineTypes>::new(2))
        ...
        .with_action(
            SendNewPayloads::<SilEngineTypes>::new()
                .with_target_node(1)
                .with_source_node(0)
                .with_start_block(1)
                .with_total_blocks(2)
...
async fn test_engine_tree_fcu_extends_canon_chain_e2e() -> Result<()> {
    ...
    let test = TestBuilder::new()
        ...
        .with_action(ReorgTo::<SilEngineTypes>::new_from_tag("target_block"))
...
async fn test_engine_tree_live_sync_transition_eventually_canonical_e2e() -> Result<()> {
    ...
    const MIN_BLOCKS_FOR_PIPELINE_RUN: u64 = 32; // EPOCH_SLOTS from alloy-sips
    ...
    let test = TestBuilder::new()
        ...
        .with_action(ProduceBlocksLocally::<SilEngineTypes>::new(MIN_BLOCKS_FOR_PIPELINE_RUN + 10))
        ...
        .with_action(ReorgTo::<SilEngineTypes>::new_from_tag("long_chain_tip"))
...
fn disk_reorg_setup(storage_v2: bool) -> Setup<SilEngineTypes> {
...
fn disk_reorg_test(storage_v2: bool) -> TestBuilder<SilEngineTypes> {
    TestBuilder::new()
        .with_setup(disk_reorg_setup(storage_v2))
        .with_action(SelectActiveNode::new(0))
        .with_action(ProduceBlocks::<SilEngineTypes>::new(3))
        .with_action(MakeCanonical::new())
        .with_action(ProduceBlocksLocally::<SilEngineTypes>::new(7))
        .with_action(MakeCanonical::with_active_node())
        .with_action(SelectActiveNode::new(1))
        .with_action(SetForkBase::new(3))
        .with_action(ProduceBlocksLocally::<SilEngineTypes>::new(8))
        .with_action(MakeCanonical::with_active_node())
        .with_action(CaptureBlock::new("fork_tip"))
        .with_action(
            SendNewPayloads::<SilEngineTypes>::new()
...
async fn test_engine_tree_disk_reorg_v1_e2e() -> Result<()> {
    rsil_tracing::init_test_tracing();
    disk_reorg_test(false).run::<SilaNode>().await?;
    Ok(())
}
...
async fn test_engine_tree_disk_reorg_v2_e2e() -> Result<()> {
    rsil_tracing::init_test_tracing();
    disk_reorg_test(true).run::<SilaNode>().await?;
    Ok(())
}
