...
mod tests {
    ...
    #[test_case("sila-mainnet-00600-a81ae85f.era1", Some(600))]
    #[test_case("sila-mainnet-00000-a81ae85f.era1", Some(0))]
    ...
    #[test_case(
        "<a href=\"sila-mainnet-00000-a6860fef.erae\">", &[".erae", ".ere"],
        Some("sila-mainnet-00000-a6860fef.erae"); "erae anchor not clipped to ere"
    )]
    #[test_case(
        "    \"name\": \"sila-mainnet-00001-05c64fc4.erae\",", &[".erae", ".ere"],
        Some("sila-mainnet-00001-05c64fc4.erae"); "erae json entry"
    )]
    #[test_case(
        "<a href=\"sila-mainnet-00600-a81ae85f.era1\">", &[".era1"],
        Some("sila-mainnet-00600-a81ae85f.era1"); "era1 anchor"
    )]
