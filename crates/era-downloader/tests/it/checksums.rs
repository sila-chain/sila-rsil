...
use rsil_era_downloader::{EraClient, EraStream, EraStreamConfig, HttpClient};
use std::str::FromStr;
use tempfile::tempdir;
use test_case::test_case;

#[test_case("https://sila-mainnet.era1.nimbus.team/"; "nimbus")]
...
for sila-mainnet-00000-5ec1ffb8.era1 at {}/sila-mainnet-00000-5ec1ffb8.era1",
        folder.display()
    );
...
for sila-mainnet-00001-a5364e9a.era1 at {}/sila-mainnet-00001-a5364e9a.era1",
        folder.display()
    );
...
impl HttpClient for FailingClient {
    async fn get<U: IntoUrl + Send + Sync>(
        ...
        Ok(futures::stream::iter(vec![Ok(match url.as_str() {
            "https://sila-mainnet.era1.nimbus.team/" => Bytes::from_static(crate::ERA1_NIMBUS),
