...
use rsil_era_downloader::{read_dir, read_era_dir};
use sha2::Digest;
use tokio::fs;
...
#[test_case::test_case(
    ...
    [
        Ok("sila-mainnet-00000-5ec1ffb8.era1"),
        Ok("sila-mainnet-00001-a5364e9a.era1"),
    ];
...
async fn test_streaming_from_local_directory(
    ...
    fs::write(folder.join("sila-mainnet-00000-5ec1ffb8.era1"), CONTENTS_0).await.unwrap();
    fs::write(folder.join("sila-mainnet-00001-a5364e9a.era1"), CONTENTS_1).await.unwrap();
...
#[test_case::test_case(
    "sila-mainnet-00000-a6860fef-noproofs.erae";
    "ERE profile postfix"
)]
#[test_case::test_case(
    "sila-mainnet-00000-00001-5ec1ffb8.era1";
    "era count segment"
)]
#[test_case::test_case(
    "sila-mainnet-00000-00001-5ec1ffb8-noproofs.ere";
...
#[test_case::test_case(
    ...
    &["sila-mainnet-00001-40cf2f3c.era", "sila-mainnet-00000-4b363db9.era"],
    &["sila-mainnet-00000-4b363db9.era", "sila-mainnet-00001-40cf2f3c.era"];
    "sorts by era number"
)]
#[test_case::test_case(
    ...
    &[
        ...
        "sila-mainnet-00000-a6860fef.ere",
        "unrelated.txt",
    ],
    &["sila-mainnet-00000-4b363db9.era"];
