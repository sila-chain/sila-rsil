...
async fn test_getting_era1_file_name_after_fetching_file_list(url: &str) {
    ...
    let expected = Some("sila-mainnet-00600-a81ae85f.era1".to_owned());
...
async fn test_getting_ere_file_name_after_fetching_file_list(url: &str) {
    ...
    let expected = Some("sila-mainnet-00001-05c64fc4.erae".to_owned());
...
async fn test_getting_era_file_name_after_fetching_file_list(url: &str) {
    ...
    let expected = Some("sila-mainnet-00500-87109713.era".to_owned());
