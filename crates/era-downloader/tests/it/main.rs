...
use futures::Stream;
use reqwest::IntoUrl;
use rsil_era_downloader::HttpClient;
...
pub(crate) const ERA1_MAINNET_0: &[u8] =
    include_bytes!("../res/era1/files/sila-mainnet-00000-5ec1ffb8.era1");
pub(crate) const ERA1_MAINNET_1: &[u8] =
    include_bytes!("../res/era1/files/sila-mainnet-00001-a5364e9a.era1");

pub(crate) const ERA_NIMBUS: &[u8] = include_bytes!("../res/era/nimbus.html");
pub(crate) const ERA_MAINNET_0: &[u8] =
    include_bytes!("../res/era/files/sila-mainnet-00000-4b363db9.era");
pub(crate) const ERA_MAINNET_1: &[u8] =
    include_bytes!("../res/era/files/sila-mainnet-00001-40cf2f3c.era");

/// Base URL of the ethPandaOps `erae` directory the ere test fixtures are served from.
pub(crate) const ERE_ETHPANDAOPS_URL: &str = "https://data.ethpandaops.io/erae/sila-mainnet/";
...
pub(crate) const ERE_MAINNET_0: &[u8] =
    include_bytes!("../res/ere/files/sila-mainnet-00000-a6860fef.erae");
pub(crate) const ERE_MAINNET_1: &[u8] =
    include_bytes!("../res/ere/files/sila-mainnet-00001-05c64fc4.erae");
...
impl HttpClient for StubClient {
    async fn get<U: IntoUrl + Send + Sync>(
        ...
        Ok(futures::stream::iter(vec![Ok(match url.as_str() {
            // Era1 urls
            "https://sila-mainnet.era1.nimbus.team/" => Bytes::from_static(ERA1_NIMBUS),
            ...
            "https://sila-mainnet.era1.nimbus.team/checksums.txt" |
            "https://era1.ethportal.net/checksums.txt" |
            "https://era.ithaca.xyz/era1/checksums.txt" => Bytes::from_static(ERA1_CHECKSUMS),
            "https://era1.ethportal.net/sila-mainnet-00000-5ec1ffb8.era1" |
            "https://sila-mainnet.era1.nimbus.team/sila-mainnet-00000-5ec1ffb8.era1" |
            "https://era.ithaca.xyz/era1/sila-mainnet-00000-5ec1ffb8.era1" => {
                Bytes::from_static(ERA1_MAINNET_0)
            }
            "https://era1.ethportal.net/sila-mainnet-00001-a5364e9a.era1" |
            "https://sila-mainnet.era1.nimbus.team/sila-mainnet-00001-a5364e9a.era1" |
            "https://era.ithaca.xyz/era1/sila-mainnet-00001-a5364e9a.era1" => {
                Bytes::from_static(ERA1_MAINNET_1)
            }
            // Ere urls
            "https://data.ethpandaops.io/erae/sila-mainnet/" => Bytes::from_static(ERE_ETHPANDAOPS),
            "https://data.ethpandaops.io/erae/sila-mainnet/checksums.txt" => {
                Bytes::from_static(ERE_CHECKSUMS)
            }
            "https://data.ethpandaops.io/erae/sila-mainnet/sila-mainnet-00000-a6860fef.erae" => {
                Bytes::from_static(ERE_MAINNET_0)
            }
            "https://data.ethpandaops.io/erae/sila-mainnet/sila-mainnet-00001-05c64fc4.erae" => {
                Bytes::from_static(ERE_MAINNET_1)
            }
            // Era urls
            "https://sila-mainnet.era.nimbus.team/" => Bytes::from_static(ERA_NIMBUS),
            "https://sila-mainnet.era.nimbus.team/sila-mainnet-00000-4b363db9.era" => {
                Bytes::from_static(ERA_MAINNET_0)
            }
            "https://sila-mainnet.era.nimbus.team/sila-mainnet-00001-40cf2f3c.era" => {
