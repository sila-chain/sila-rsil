...
use rsil_era_utils::{export, Era1, ExportConfig};
use rsil_fs_util as fs;
use rsil_provider::{test_utils::create_test_provider_factory, BlockReader};
...
fn test_export_with_genesis_only() {
    ...
    assert!(
        file_name.starts_with("sila-mainnet-00000-"),
