...
use rsil_era_downloader::{EraMeta, HttpClient};
...
const GENESIS_ITHACA_INDEX_RESPONSE: &[u8] = b"<a href=\"https://era.ithaca.xyz/era1/sila-mainnet-00000-5ec1ffb8.era1\">sila-mainnet-00000-5ec1ffb8.era1</a>";
