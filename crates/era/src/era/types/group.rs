...
//!
//! See also <https://github.com/sil-clients/e2store-format-specs/blob/main/formats/era.md>
...
/// See also <https://github.com/sil-clients/e2store-format-specs/blob/main/formats/era.md#structure>
#[derive(Debug)]
pub struct EraGroup {
...
mod tests {
    ...
    #[test_case::test_case(
        EraId::new("sila-mainnet", 0, 8192).with_hash([0x4b, 0x36, 0x3d, 0xb9]),
        "sila-mainnet-00000-4b363db9.era";
        "SilaMainnet era 0"
    )]
    #[test_case::test_case(
        EraId::new("sila-mainnet", 8192, 8192).with_hash([0x40, 0xcf, 0x2f, 0x3c]),
        "sila-mainnet-00001-40cf2f3c.era";
        "SilaMainnet era 1"
    )]
    #[test_case::test_case(
        EraId::new("sila-mainnet", 0, 8192),
        "sila-mainnet-00000-00000000.era";
        "Without hash"
    )]
    ...
    #[test_case::test_case(
        EraId::new("sila-mainnet", 0, 8192).with_hash([0x4b, 0x36, 0x3d, 0xb9]).with_era_count(),
        "sila-mainnet-00000-00001-4b363db9.era";
        "SilaMainnet era 0 with count"
    )]
    #[test_case::test_case(
        EraId::new("sila-mainnet", 8000, 500).with_hash([0xab, 0xcd, 0xef, 0x12]).with_era_count(),
        "sila-mainnet-00000-00002-abcdef12.era";
