...
mod tests {
    ...
    fn test_era1_roundtrip_file() -> Result<(), E2sError> {
        ...
        let era1_file = create_test_era1_file(2000, 3, "sila-mainnet");
        Era1Writer::create(&file_path, &era1_file)?;

        // Read it back
        let read_era1 = Era1Reader::open(&file_path, "sila-mainnet")?;

        // Verify core properties
        assert_eq!(read_era1.id.network_name, "sila-mainnet");
