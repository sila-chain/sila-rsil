...
//! use rsil_era::{common::decode::DecodeCompressedRlp, era1::types::execution::CompressedHeader};
//!
...
//! # Ok::<(), rsil_era::e2s::error::E2sError>(())
//! ```
//!
//! ## [`CompressedBody`]
//!
...
//! use rsil_era::{common::decode::DecodeCompressedRlp, era1::types::execution::CompressedBody};
...
//!
//! ```rust
//! use alloy_consensus::{Sip658Value, Receipt, ReceiptEnvelope, ReceiptWithBloom};
//! use rsil_era::{
//!     common::decode::DecodeCompressedRlp, era1::types::execution::CompressedReceipts,
//! };
//!
//! let receipt =
//!     Receipt { status: Sip658Value::Sip658(true), cumulative_gas_used: 21000, logs: vec![] };
...
mod tests {
    ...
    fn test_total_difficulty_ssz_le_encoding() {
        ...
        // See https://github.com/sil-clients/e2store-format-specs/blob/main/formats/era1.md
