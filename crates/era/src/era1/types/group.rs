...
//!
//! See also <https://github.com/sil-clients/e2store-format-specs/blob/main/formats/era1.md>
...
mod tests {
    ...
    #[test_case::test_case(
        Era1Id::new("sila-mainnet", 0, 8192).with_hash([0x5e, 0xc1, 0xff, 0xb8]),
        "sila-mainnet-00000-5ec1ffb8.era1";
        "SilaMainnet era 0"
    )]
    #[test_case::test_case(
        Era1Id::new("sila-mainnet", 8192, 8192).with_hash([0x5e, 0xcb, 0x9b, 0xf9]),
        "sila-mainnet-00001-5ecb9bf9.era1";
        "SilaMainnet era 1"
    )]
    #[test_case::test_case(
    ...
    #[test_case::test_case(
        Era1Id::new("sila-mainnet", 1000, 100),
        "sila-mainnet-00000-00000000.era1";
        "ID without hash"
    )]
    #[test_case::test_case(
    ...
    #[test_case::test_case(
        Era1Id::new("sila-mainnet", 0, 8192).with_hash([0x5e, 0xc1, 0xff, 0xb8]).with_era_count(),
        "sila-mainnet-00000-00001-5ec1ffb8.era1";
        "SilaMainnet era 0 with count"
    )]
    #[test_case::test_case(
        Era1Id::new("sila-mainnet", 8000, 500).with_hash([0xab, 0xcd, 0xef, 0x12]).with_era_count(),
        "sila-mainnet-00000-00002-abcdef12.era1";
