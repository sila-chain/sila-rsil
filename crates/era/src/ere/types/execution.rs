...
//!
//! See also <https://github.com/sil-clients/e2store-format-specs/blob/main/formats/ere.md>
...
pub enum ProofType {
    ...
    /// SilaDeneb-era proof against historical summaries
...
mod tests {
    ...
    fn test_receipt_list_compression() {
        ...
        // bare `Receipt` (`alloy_consensus::SilaReceipt`) is the canonical decode target.
