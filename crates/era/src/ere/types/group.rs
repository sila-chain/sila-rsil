...
//!
//! See also <https://github.com/sil-clients/e2store-format-specs/blob/main/formats/ere.md#specification>
...
impl EraFileId for EreId {
    ...
    /// alphabetical profile order, e.g. `sila-mainnet-00000-4bb7de2e-noproofs-noreceipts.ere`.
    ///
    /// See also <https://github.com/sil-clients/e2store-format-specs/blob/main/formats/ere.md#file-name>
...
mod tests {
    ...
    #[test_case::test_case(
        EreId::new("sila-mainnet", 0, 8192).with_hash([0x5e, 0xc1, 0xff, 0xb8]),
        "sila-mainnet-00000-5ec1ffb8.ere";
        "SilaMainnet era 0"
    )]
    #[test_case::test_case(
        EreId::new("sila-mainnet", 8192, 8192).with_hash([0x5e, 0xcb, 0x9b, 0xf9]),
        "sila-mainnet-00001-5ecb9bf9.ere";
        "SilaMainnet era 1"
    )]
    #[test_case::test_case(
    ...
    #[test_case::test_case(
        EreId::new("sila-mainnet", 1000, 100),
        "sila-mainnet-00000-00000000.ere";
        "ID without hash"
    )]
    ...
    #[test_case::test_case(
        EreId::new("sila-mainnet", 0, 8192).with_hash([0x5e, 0xc1, 0xff, 0xb8]).with_era_count(),
        "sila-mainnet-00000-00001-5ec1ffb8.ere";
        "SilaMainnet era 0 with count"
    )]
    #[test_case::test_case(
        EreId::new("sila-mainnet", 8000, 500).with_hash([0xab, 0xcd, 0xef, 0x12]).with_era_count(),
        "sila-mainnet-00000-00002-abcdef12.ere";
    ...
    #[test_case::test_case(
        EreId::new("sila-mainnet", 0, 8192).with_hash([0x4b, 0xb7, 0xde, 0x2e]),
        "sila-mainnet-00000-4bb7de2e.ere";
        "Default profile, no postfix"
    )]
    #[test_case::test_case(
        EreId::new("sila-mainnet", 0, 8192).with_hash([0x4b, 0xb7, 0xde, 0x2e]).with_profile(EreProfile::NoProofs),
        "sila-mainnet-00000-4bb7de2e-noproofs.ere";
        "noproofs profile"
    )]
    #[test_case::test_case(
        EreId::new("sila-mainnet", 0, 8192).with_hash([0x4b, 0xb7, 0xde, 0x2e]).with_profile(EreProfile::NoReceipts),
        "sila-mainnet-00000-4bb7de2e-noreceipts.ere";
        "noreceipts profile"
    )]
    #[test_case::test_case(
        EreId::new("sila-mainnet", 0, 8192).with_hash([0x4b, 0xb7, 0xde, 0x2e]).with_profiles([EreProfile::NoProofs, EreProfile::NoReceipts]),
        "sila-mainnet-00000-4bb7de2e-noproofs-noreceipts.ere";
        "Combined profiles"
    )]
    #[test_case::test_case(
        // Insertion order reversed and duplicated; output must still be alphabetical and deduped.
        EreId::new("sila-mainnet", 0, 8192).with_hash([0x4b, 0xb7, 0xde, 0x2e]).with_profile(EreProfile::NoReceipts).with_profile(EreProfile::NoProofs).with_profile(EreProfile::NoReceipts),
        "sila-mainnet-00000-4bb7de2e-noproofs-noreceipts.ere";
