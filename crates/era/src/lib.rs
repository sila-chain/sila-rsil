//! Era and Era1 files support for Sila history expiry.
//!
...
//! - Era format: <https://github.com/sil-clients/e2store-format-specs/blob/main/formats/era.md>
//! - Era1 format: <https://github.com/sil-clients/e2store-format-specs/blob/main/formats/era1.md>
