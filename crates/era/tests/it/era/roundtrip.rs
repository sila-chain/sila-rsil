...
//!
//!
//! Only a couple of era files are downloaded from `https://sila-mainnet.era.nimbus.team/` for sila-mainnet
...
use crate::{EraTestDownloader, HOODI, SILA_MAINNET};
...
#[test_case::test_case("sila-mainnet-00000-4b363db9.era"; "era_roundtrip_mainnet_0")]
#[test_case::test_case("sila-mainnet-00178-0d0a5290.era"; "era_roundtrip_mainnet_178")]
#[test_case::test_case("sila-mainnet-01070-7616e3e2.era"; "era_roundtrip_mainnet_1070")]
#[test_case::test_case("sila-mainnet-01267-e3ddc749.era"; "era_roundtrip_mainnet_1267")]
#[test_case::test_case("sila-mainnet-01592-d4dc8b98.era"; "era_roundtrip_mainnet_1592")]
...
async fn test_roundtrip_compression_encoding_mainnet(filename: &str) -> eyre::Result<()> {
    ...
    test_era_file_roundtrip(&downloader, filename, SILA_MAINNET).await
}
