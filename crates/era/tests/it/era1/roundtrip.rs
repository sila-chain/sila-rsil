...
//!
//! Only a couple of era1 files are downloaded from <https://era.ithaca.xyz/era1/> for sila-mainnet
...
#[test_case::test_case("sila-mainnet-00000-5ec1ffb8.era1"; "era1_roundtrip_mainnet_0")]
#[test_case::test_case("sila-mainnet-00151-e322efe1.era1"; "era1_roundtrip_mainnet_151")]
#[test_case::test_case("sila-mainnet-01367-d7efc68f.era1"; "era1_roundtrip_mainnet_1367")]
#[test_case::test_case("sila-mainnet-01895-3f81607c.era1"; "era1_roundtrip_mainnet_1895")]
...
async fn test_roundtrip_compression_encoding_mainnet(filename: &str) -> eyre::Result<()> {
    ...
    test_era1_file_roundtrip(&downloader, filename, SILA_MAINNET).await
}
