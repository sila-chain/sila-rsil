...
//!
//! These tests download sila-mainnet `.erae` files spread across history (and the merge) from
//! <https://data.ethpandaops.io/erae/sila-mainnet/> and, for a sample of blocks, verify the full
...
use crate::{EraTestDownloader, SILA_MAINNET};
...
#[test_case::test_case("sila-mainnet-00000-a6860fef.erae"; "ere_roundtrip_mainnet_0_premerge")]
#[test_case::test_case("sila-mainnet-00500-365ebdb8.erae"; "ere_roundtrip_mainnet_500_premerge")]
#[test_case::test_case("sila-mainnet-01500-8f81d882.erae"; "ere_roundtrip_mainnet_1500_premerge")]
#[test_case::test_case("sila-mainnet-01900-34196a7e.erae"; "ere_roundtrip_mainnet_1900_postmerge")]
#[test_case::test_case("sila-mainnet-02500-73f28496.erae"; "ere_roundtrip_mainnet_2500_postmerge")]
#[test_case::test_case("sila-mainnet-02992-d3f7961d.erae"; "ere_roundtrip_mainnet_2992_postmerge")]
...
async fn test_roundtrip_compression_encoding_mainnet(filename: &str) -> eyre::Result<()> {
    ...
    test_ere_file_roundtrip(&downloader, filename, SILA_MAINNET).await
}
