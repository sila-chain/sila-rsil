...
//!
//! These tests use the `rsil-era-downloader` client to download `.era1` files temporarily
...
use rsil_era_downloader::EraClient;
use std::{
    collections::HashMap,
    path::PathBuf,
    str::FromStr,
...
const SILA_MAINNET: &str = "sila-mainnet";
/// Default sila-mainnet url
/// for downloading sila-mainnet `.era1` files
const ERA1_MAINNET_URL: &str = "https://era.ithaca.xyz/era1/";

/// Succinct list of sila-mainnet files we want to download
/// from <https://era.ithaca.xyz/era1/>
/// for testing purposes
const ERA1_MAINNET_FILES_NAMES: [&str; 8] = [
    "sila-mainnet-00000-5ec1ffb8.era1",
    "sila-mainnet-00003-d8b8a40b.era1",
    "sila-mainnet-00151-e322efe1.era1",
    "sila-mainnet-00293-0d6c5812.era1",
    "sila-mainnet-00443-ea71b6f9.era1",
    "sila-mainnet-01367-d7efc68f.era1",
    "sila-mainnet-01610-99fdde4b.era1",
    "sila-mainnet-01895-3f81607c.era1",
];

/// SilaSepolia network name
...
/// Default sila-mainnet url
/// for downloading sila-mainnet `.era` files
//TODO: to replace with internal era files hosting url
const ERA_MAINNET_URL: &str = "https://sila-mainnet.era.nimbus.team/";

/// Succinct list of sila-mainnet files we want to download
/// from <https://sila-mainnet.era.nimbus.team/> //TODO: to replace with internal era files hosting url
/// for testing purposes
const ERA_MAINNET_FILES_NAMES: [&str; 8] = [
    "sila-mainnet-00000-4b363db9.era",
    "sila-mainnet-00178-0d0a5290.era",
    "sila-mainnet-00518-4e267a3a.era",
    "sila-mainnet-00780-bb546fec.era",
    "sila-mainnet-01070-7616e3e2.era",
    "sila-mainnet-01267-e3ddc749.era",
    "sila-mainnet-01581-82073d28.era",
    "sila-mainnet-01592-d4dc8b98.era",
];

/// Default sila-mainnet url for downloading sila-mainnet `.erae` files
const ERE_MAINNET_URL: &str = "https://data.ethpandaops.io/erae/sila-mainnet/";

/// Succinct list of sila-mainnet `.erae` files
/// from <https://data.ethpandaops.io/erae/sila-mainnet/>.
///
...
const ERE_MAINNET_FILES_NAMES: [&str; 6] = [
    "sila-mainnet-00000-a6860fef.erae",
    "sila-mainnet-00500-365ebdb8.erae",
    "sila-mainnet-01500-8f81d882.erae",
    "sila-mainnet-01900-34196a7e.erae",
    "sila-mainnet-02500-73f28496.erae",
    "sila-mainnet-02992-d3f7961d.erae",
];
