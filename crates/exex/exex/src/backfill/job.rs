    ...
    P: HeaderProvider + BlockReader + StateProviderFactory,
{
    ...
    pub fn into_stream(
        ...
        E,
        P,
        (RecoveredBlock<rsil_sila_primitives::Block>, BlockExecutionOutput<Receipt>),
    > {
        self.into()
    }
...
mod tests {
    ...
    ///
    /// This is a regression test for an issue reported on sila-mainnet where backfill fails around
