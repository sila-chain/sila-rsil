...
//! passed an [`ExExContext`] where it is possible to spawn additional tasks and modify Rsil.
//!
...
//! processed. This event is used by Rsil to determine what state can be pruned.
//!
...
//! use rsil_provider::CanonStateNotification;
//!
...
//! ## Assumptions
//!
//! - `ExExs` run indefinitely alongside Rsil
...
//! ## Invariants
//!
//! - An ExEx must not block the main Rsil execution
...
//! [`CanonStateNotification`]: rsil_provider::CanonStateNotification
#![doc(
