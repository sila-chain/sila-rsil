...
///
/// 1024 notifications in the buffer is 3.5 hours of sila-mainnet blocks,
...
///
/// This value is appropriate for Sila sila-mainnet with ~12 second block times. For L2 chains with
...
#[derive(Debug)]
pub struct ExExHandle<N: NodePrimitives = SilPrimitives> {
...
#[derive(Debug)]
pub struct ExExManagerHandle<N: NodePrimitives = SilPrimitives> {
