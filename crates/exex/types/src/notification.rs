...
pub enum ExExNotification<N: NodePrimitives = rsil_chain_state::SilPrimitives> {
...
pub(super) mod serde_bincode_compat {
    ...
    /// ```rust
    /// use rsil_exex_types::{serde_bincode_compat, ExExNotification};
    /// use rsil_primitives_traits::NodePrimitives;
    ...
    mod tests {
        ...
        fn test_exex_notification_bincode_roundtrip() {
            ...
            struct Data {
                #[serde_as(
                    as = "serde_bincode_compat::ExExNotification<'_, rsil_sila_primitives::SilPrimitives>"
                )]
