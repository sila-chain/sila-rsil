...
use enr::Enr;
use rsil_network_peers::{pk2id, NodeRecord, PeerId};
...
pub enum Message {
    ...
    /// Represents an ENR request message, a request for Sila Node Records (ENR) as per [SIP-778](https://sips.sila.org/SIPS/sip-778).
    EnrRequest(EnrRequest),
    /// Represents an ENR response message, a response to an ENR request with Sila Node Records (ENR) as per [SIP-778](https://sips.sila.org/SIPS/sip-778).
...
impl Message {
    ...
    /// Encodes the UDP datagram, See <https://github.com/sila-chain/devp2p/blob/master/discv4.md#wire-protocol>
    ///
...
impl alloy_rlp::Decodable for PingNodeEndpoint {
    ...
    fn decode(b: &mut &[u8]) -> alloy_rlp::Result<Self> {
        ...
        // <https://github.com/sila-chain/go-sila/blob/380688c636a654becc8f114438c2a5d93d2db032/p2p/discover/v4_udp.go#L206-L209>
        // <https://github.com/sila-chain/go-sila/blob/380688c636a654becc8f114438c2a5d93d2db032/p2p/enode/node.go#L189-L189>
        //
...
/// A [FindNode packet](https://github.com/sila-chain/devp2p/blob/master/discv4.md#findnode-packet-0x03).
...
impl Decodable for FindNode {
    // NOTE(onbjerg): Manual implementation to satisfy SIP-8.
    //
    // See https://sips.sila.org/SIPS/sip-8
    fn decode(buf: &mut &[u8]) -> alloy_rlp::Result<Self> {
        ...
        // NOTE(onbjerg): Because of SIP-8, we only check that we did not consume *more* than the
...
/// A [Neighbours packet](https://github.com/sila-chain/devp2p/blob/master/discv4.md#neighbors-packet-0x04).
...
/// A [ENRRequest packet](https://github.com/sila-chain/devp2p/blob/master/discv4.md#enrrequest-packet-0x05).
///
/// This packet is used to request the current version of a node's Sila Node Record (ENR).
#[derive(Clone, Copy, Debug, Eq, PartialEq, RlpEncodable)]
...
/// A [ENRResponse packet](https://github.com/sila-chain/devp2p/blob/master/discv4.md#enrresponse-packet-0x06).
///
...
pub struct EnrResponse {
    ...
    /// The ENR (Sila Node Record) for the responding node.
...
impl EnrResponse {
    ...
    ///
    /// See also <https://github.com/sila-chain/go-sila/blob/9244d5cd61f3ea5a7645fdf2a1a96d53421e412f/sil/protocols/sil/discovery.go#L36>
    pub fn eth_fork_id(&self) -> Option<ForkId> {
        let mut maybe_fork_id = self.enr.get_raw_rlp(b"sil")?;
...
///
/// A [Ping packet](https://github.com/sila-chain/devp2p/blob/master/discv4.md#ping-packet-0x01).
...
pub struct Ping {
    ...
    pub expire: u64,
    /// Optional `enr_seq` for <https://sips.sila.org/SIPS/sip-868>
...
///
/// A [Pong packet](https://github.com/sila-chain/devp2p/blob/master/discv4.md#pong-packet-0x02).
...
mod tests {
    ...
    fn encode_decode_enr_msg() {
        ...
        let enr = {
            ...
            builder.add_value_rlp("sil", buf.into());
    ...
    mod sip8 {
        ...
        // checks that junk data at the end of the packet is discarded according to sip-8
        #[test]
        fn sip8_decode_enr_request() {
        ...
        // checks that junk data at the end of the packet is discarded according to sip-8
        //
        // test vector from sip-8: https://sips.sila.org/SIPS/sip-8
        #[test]
        fn sip8_decode_findnode() {
