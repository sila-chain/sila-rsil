...
use rsil_primitives_traits::{Block, InMemorySize, SealedHeader};
use rsil_storage_api::HeaderProvider;
...
mod tests {
    ...
    async fn streams_bodies_in_order() {
        ...
        let mut downloader = BodiesDownloaderBuilder::default()
            .build::<rsil_sila_primitives::Block, _, _>(
                client.clone(),
