...
use rsil_consensus::{Consensus, ConsensusError};
...
use rsil_primitives_traits::{Block, BlockBody, FullBlock, SealedBlock, SealedHeader};
...
impl<B: FullBlock<Header: rsil_primitives_traits::BlockHeader>> FromReader
