...
use rayon::prelude::*;
use rsil_config::config::HeadersConfig;
...
/// [`rsil_network_p2p::headers::client::HeadersDirection`], this means the batches of headers that
...
where
    H: HeadersClient<Header: rsil_primitives_traits::BlockHeader> + 'static,
{
...
impl Default for ReverseHeadersDownloaderBuilder {
    fn default() -> Self {
        Self {
            ...
            // This is just below the max number of headers commonly in a headers response (1024), see also <https://github.com/sila-chain/go-sila/blob/b0d44338bbcefee044f1f635a84487cbbd8f0538/sil/protocols/sil/handler.go#L38-L40>
