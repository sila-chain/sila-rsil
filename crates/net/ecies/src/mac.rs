//! # Sila MAC Module
//!
//! This module provides the implementation of the Sila MAC (Message Authentication Code)
//! construction, as specified in the Sila `RLPx` protocol.
//!
//! The Sila MAC is a nonstandard MAC construction that utilizes AES-256 (as a block cipher)
//! and Keccak-256. It is specifically designed for messages of 128 bits in length and is not
//! intended for general MAC use.
//!
//! For more information, refer to the [Sila MAC specification](https://github.com/sila-chain/devp2p/blob/master/rlpx.md#mac).
...
/// [`Sila MAC`](https://github.com/sila-chain/devp2p/blob/master/rlpx.md#mac) state.
///
/// The sila MAC is a cursed MAC construction.
///
/// The sila MAC is a nonstandard MAC construction that uses AES-256 (without a mode, as a
