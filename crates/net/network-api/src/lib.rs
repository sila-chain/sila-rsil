//! Rsil interface definitions and commonly used types for the rsil-network crate.
//!
//! Provides abstractions for the rsil-network crate.
//!
//! ## Feature Flags
//!
...
pub trait NetworkInfo: Send + Sync {
    ...
    /// Returns shared blob cell custody state for [SIP-8070] sparse blobpool sampling.
    ///
...
pub trait PeersInfo: Send + Sync {
    ...
    /// Returns the Sila Node Record of the node.
...
pub trait Peers: PeersInfo {
    ...
    fn add_trusted_peer_node(&self, _peer: rsil_network_peers::TrustedPeer) {}
