...
use rsil_network_types::{PeerKind, Reputation, ReputationChangeKind};
...
#[derive(Debug, Clone)]
#[non_exhaustive]
pub struct NoopNetwork<Net = SilNetworkPrimitives> {
    chain_id: u64,
...
impl Default for NoopNetwork<SilNetworkPrimitives> {
    fn default() -> Self {
        Self::new()
    }
}
...
{
    fn update_status(&self, _head: rsil_sila_forks::Head) {}
