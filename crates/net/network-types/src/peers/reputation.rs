...
pub enum ReputationChangeKind {
    ...
    ///
    /// Note: this will we only used in pre-merge, pow consensus, since after no more block announcements are sent via devp2p: [SIP-3675](https://sips.sila.org/SIPS/sip-3675#devp2p)
    BadBlock,
    ...
    /// peer.
    ///
    /// According to the [Sil spec](https://github.com/sila-chain/devp2p/blob/master/caps/sil.md):
    ///
