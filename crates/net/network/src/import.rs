...
#[derive(Debug)]
pub enum BlockImportEvent<B = rsil_sila_primitives::Block> {
...
#[derive(Debug)]
pub struct BlockImportOutcome<B = rsil_sila_primitives::Block> {
...
pub enum BlockImportError {
    /// Consensus error
    #[error(transparent)]
    Consensus(#[from] rsil_consensus::ConsensusError),
    /// Other error
    #[error(transparent)]
...
///
/// Block propagation over devp2p is invalid in POS: [SIP-3675](https://sips.sila.org/SIPS/sip-3675#devp2p)
