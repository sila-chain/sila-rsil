...
///
/// This type is mainly used to connect peers on shadow forks (e.g. sila-mainnet shadowfork)
    ...
    N: NetworkEventListenerProvider + Peers + Clone + Send + Sync + 'static,
{
    ...
    async fn check_peer_blocks(
        network: N,
        peer_id: rsil_network_api::PeerId,
        messages: rsil_network_api::PeerRequestSender<PeerRequest<N::Primitives>>,
        block_num_hashes: Vec<BlockNumHash>,
