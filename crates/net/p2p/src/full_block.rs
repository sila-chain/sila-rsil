    ...
    Client: BlockClient,
{
    ...
    pub fn test_client(client: Client) -> Self {
        Self::new(client, Arc::new(rsil_consensus::test_utils::TestConsensus::default()))
    }
}
    ...
    fn poll_access_lists(&mut self, cx: &mut Context<'_>) {
        ...
        match poll {
            ...
            Poll::Ready(Err(err)) => {
                ...
                // Optional BAL lookup is best-effort: missing sil/71 support or request failures
...
#[derive(Debug, Clone)]
#[non_exhaustive]
pub struct NoopFullBlockClient<Net = SilNetworkPrimitives>(PhantomData<Net>);
...
mod tests {
    ...
    async fn download_full_block_range_with_invalid_header() {
        ...
        let test_consensus = rsil_consensus::test_utils::TestConsensus::default();
