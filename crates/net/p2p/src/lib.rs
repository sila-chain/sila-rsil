...
/// [`HeadersClient`].
///
/// [`Consensus`]: rsil_consensus::Consensus
...
pub use rsil_eth_wire_types::BlockAccessLists;
...
/// The [`BlockClient`] providing Sila block parts.
pub trait SilBlockClient: BlockClient<Block = rsil_sila_primitives::Block> {}

impl<T> SilBlockClient for T where T: BlockClient<Block = rsil_sila_primitives::Block> {}
