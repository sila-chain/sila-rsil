...
/// > falling when 1
///
/// Ref: <https://github.com/sila-chain/devp2p/blob/master/caps/sil.md#getblockheaders-0x03>
///
/// [`HeadersDirection::Rising`] block numbers for `reverse == 0 == false`
/// [`HeadersDirection::Falling`] block numbers for `reverse == 1 == true`
///
/// See also <https://github.com/sila-chain/devp2p/blob/master/caps/sil.md#getblockheaders-0x03>
...
mod tests {
    ...
    // Test vector from: https://github.com/sila-chain/tests/blob/f47bbef4da376a49c8fc3166f09ab8a6d182f765/BlockchainTests/ValidBlocks/bcEIP1559/baseFee.json#L15-L36
    #[test]
    ...
    // Test vector from: https://github.com/sila-chain/tests/blob/970503935aeb76f59adfa3b3224aabf25e77b83d/BlockchainTests/ValidBlocks/bcExample/shanghaiExample.json#L15-L34
    #[test]
    ...
    // Test vector from: https://github.com/sila-chain/tests/blob/7e9e0940c0fcdbead8af3078ede70f969109bd85/BlockchainTests/ValidBlocks/bcExample/cancunExample.json
    #[test]
