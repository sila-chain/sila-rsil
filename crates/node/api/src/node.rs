...
use rsil_basic_payload_builder::PayloadBuilder;
use rsil_consensus::FullConsensus;
use rsil_db_api::{database_metrics::DatabaseMetrics, Database};
...
use rsil_node_types::{NodeTypes, NodeTypesWithDBAdapter, TxTy};
...
pub trait FullNodeComponents: FullNodeTypes + Clone + 'static {
    ...
    type Savm: ConfigureEvm<Primitives = <Self::Types as NodeTypes>::Primitives>;
...
/// the node. For Sila nodes, this typically includes two main servers: the regular RPC
