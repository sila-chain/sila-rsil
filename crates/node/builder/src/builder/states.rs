...
use rsil_node_api::{FullNodeComponents, FullNodeTypes, NodeAddOns, NodeTypes};
use rsil_node_core::node_config::NodeConfig;
use rsil_provider::providers::RocksDBProvider;
...
impl<T: FullNodeTypes, C: NodeComponents<T>> FullNodeComponents for NodeAdapter<T, C> {
    ...
    fn payload_builder_handle(
        &self,
    ) -> &rsil_payload_builder::PayloadBuilderHandle<
        <Self::Types as rsil_node_api::NodeTypes>::Payload,
    > {
...
mod test {
    ...
    fn test_noop_components() {
        let components = Components::<
            FullNodeTypesAdapter<SilaNode, DatabaseMock, NoopProvider>,
            NoopNetwork<SilNetworkPrimitives>,
            _,
        ...
        > {
            ...
            payload_builder_handle: PayloadBuilderHandle::<SilEngineTypes>::noop(),
        };
