...
use rsil_basic_payload_builder::{BasicPayloadJobGenerator, BasicPayloadJobGeneratorConfig};
use rsil_chain_state::CanonStateSubscriptions;
use rsil_node_api::{NodeTypes, PayloadBuilderFor};
use rsil_payload_builder::{PayloadBuilderHandle, PayloadBuilderService, PayloadServiceCommand};
...
pub trait PayloadServiceBuilder<Node: FullNodeTypes, Pool: TransactionPool, SavmConfig>:
    Send + Sized
{
...
impl<Node, F, Fut, Pool, SavmConfig> PayloadServiceBuilder<Node, Pool, SavmConfig> for F
where
    Node: FullNodeTypes,
    Pool: TransactionPool,
    F: Fn(&BuilderContext<Node>, Pool, SavmConfig) -> Fut + Send,
...
pub trait PayloadBuilderBuilder<Node: FullNodeTypes, Pool: TransactionPool, SavmConfig>:
    Send + Sized
{
...
impl<Node, Pool, PB, SavmConfig> PayloadServiceBuilder<Node, Pool, SavmConfig>
    for BasicPayloadServiceBuilder<PB>
where
    Node: FullNodeTypes,
    Pool: TransactionPool,
    SavmConfig: Send,
    PB: PayloadBuilderBuilder<Node, Pool, SavmConfig>,
{
...
impl<Node, Pool, Savm> PayloadServiceBuilder<Node, Pool, Savm> for NoopPayloadServiceBuilder
where
    Node: FullNodeTypes,
    Pool: TransactionPool,
    Savm: Send,
