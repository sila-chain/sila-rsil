...
use rsil_node_core::exit::NodeExitFuture;

use crate::{node::FullNode, rpc::RsilRpcAddOns};

/// A Handle to the launched node.
#[must_use = "Needs to await the node exit future"]
pub struct NodeHandle<Node: FullNodeComponents, AddOns: RsilRpcAddOns<Node>> {
    /// All node components.
