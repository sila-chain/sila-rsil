...
pub struct DatadirArgs {
    ...
    ///
    /// - Linux: `$XDG_DATA_HOME/rsil/` or `$HOME/.local/share/rsil/`
    /// - Windows: `{FOLDERID_RoamingAppData}/rsil/`
    /// - macOS: `$HOME/Library/Application Support/rsil/`
...
mod tests {
    ...
    fn test_parse_datadir_args() {
        ...
        let args = CommandParser::<DatadirArgs>::parse_from(["rsil"]).args;
