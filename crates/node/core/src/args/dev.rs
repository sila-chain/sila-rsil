...
pub struct DevArgs {
    ...
    /// test junk" with 10 000 SIL each.
...
mod tests {
    ...
    fn test_parse_dev_args() {
        let args = CommandParser::<DevArgs>::parse_from(["rsil"]).args;
        assert_eq!(
            args,
            DevArgs {
                dev: false,
        ...
        let args = CommandParser::<DevArgs>::parse_from(["rsil", "--dev"]).args;
        assert_eq!(
            args,
            DevArgs {
                dev: true,
        ...
        let args = CommandParser::<DevArgs>::parse_from(["rsil", "--auto-mine"]).args;
        assert_eq!(
            args,
            DevArgs {
                dev: true,
        ...
        let args =
            CommandParser::<DevArgs>::parse_from(["rsil", "--dev", "--dev.block-time", "1s"]).args;
        assert_eq!(
            args,
            DevArgs {
                dev: true,
