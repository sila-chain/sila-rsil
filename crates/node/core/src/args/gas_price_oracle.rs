...
use clap::Args;
use rsil_rpc_eth_types::GasPriceOracleConfig;
use rsil_rpc_server_types::constants::gas_oracle::{
...
mod tests {
    ...
    fn test_parse_gpo_args() {
        let args = CommandParser::<GasPriceOracleArgs>::parse_from(["rsil"]).args;
        assert_eq!(
            args,
            GasPriceOracleArgs {
                blocks: DEFAULT_GAS_PRICE_BLOCKS,
