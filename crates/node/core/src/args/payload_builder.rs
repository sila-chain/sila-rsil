...
mod tests {
    ...
    fn test_args_with_valid_max_tasks() {
        let args =
            CommandParser::<PayloadBuilderArgs>::parse_from(["rsil", "--builder.max-tasks", "1"])
                .args;
    ...
    fn payload_builder_args_default_sanity_check() {
        ...
        let args = CommandParser::<PayloadBuilderArgs>::parse_from(["rsil"]).args;
    ...
    fn test_args_with_s_interval() {
        let args =
            CommandParser::<PayloadBuilderArgs>::parse_from(["rsil", "--builder.interval", "50"])
                .args;
    ...
    fn test_args_with_ms_interval() {
        let args =
            CommandParser::<PayloadBuilderArgs>::parse_from(["rsil", "--builder.interval", "50ms"])
                .args;
