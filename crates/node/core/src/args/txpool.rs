...
pub struct TxPoolArgs {
    ...
    /// Disable SIP-4844 blob transaction support
...
impl TxPoolArgs {
    ...
    /// value the sila SIP-1559 base fee can reach.
    ...
    ///
    /// Sila's SIP-1559 base fee can't drop below [`MIN_PROTOCOL_BASE_FEE`] hence this is
...
impl RsilTransactionPoolConfig for TxPoolArgs {
...
mod tests {
    ...
    fn txpool_args_default_sanity_test() {
        ...
        let args = CommandParser::<TxPoolArgs>::parse_from(["rsil"]).args;
    ...
    fn txpool_parse_max_tx_lifetime() {
        ...
        let args =
            CommandParser::<TxPoolArgs>::parse_from(["rsil", "--txpool.lifetime", "300"]).args;
    ...
    fn txpool_parse_max_tx_lifetime_invalid() {
        let result =
            CommandParser::<TxPoolArgs>::try_parse_from(["rsil", "--txpool.lifetime", "invalid"]);
