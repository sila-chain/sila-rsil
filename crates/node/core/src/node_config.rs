...
impl<ChainSpec> NodeConfig<ChainSpec> {
    ...
    where
        ...
        Client: HeadersClient<Header: rsil_primitives_traits::BlockHeader>,
    {
    ...
    where
        Client: HeadersClient<Header: rsil_primitives_traits::BlockHeader>,
    {
        info!(target: "rsil::cli", ?tip, "Fetching tip block from the network.");
            ...
            match get_single_header(&client, tip).await {
                ...
                Err(error) => {
                    ...
                    if fetch_failures % 20 == 0 {
                        error!(target: "rsil::cli", ?fetch_failures, %error, "Failed to fetch the tip. Retrying...");
                    }
                }
            }
        }
