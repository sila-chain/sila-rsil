...
pub struct RsilCliVersionConsts {
    ...
    /// The short version information for rsil.
    pub short_version: Cow<'static, str>,

    /// The long version information for rsil.
    pub long_version: Cow<'static, str>,
    /// The build profile name.
    pub build_profile_name: Cow<'static, str>,

    /// The version information for rsil formatted for P2P (devp2p).
    ///
    /// - The latest version from Cargo.toml
    /// - The target triple
    ///
    ...
    ///
    /// ```text
    /// rsil/v{major}.{minor}.{patch}-{sha1}/{target}
    /// ```
    /// e.g.: `rsil/v0.1.0-alpha.1-428a6dc2f/aarch64-apple-darwin`
...
///
/// ```text
/// rsil/v{major}.{minor}.{patch}/{OS}
/// ```
pub fn default_extra_data() -> String {
    format!("rsil/v{}/{}", env!("CARGO_PKG_VERSION"), std::env::consts::OS)
}
...
pub fn version_metadata() -> &'static RsilCliVersionConsts {
    VERSION_METADATA.get_or_init(default_rsil_version_metadata)
}

/// default rsil version metadata using compile-time env! macros.
pub fn default_rsil_version_metadata() -> RsilCliVersionConsts {
    RsilCliVersionConsts {
        name_client: Cow::Borrowed("Rsil"),
        ...
        short_version: Cow::Borrowed(env!("RSIL_SHORT_VERSION")),
        long_version: Cow::Owned(format!(
            "{}\n{}\n{}\n{}\n{}",
            env!("RSIL_LONG_VERSION_0"),
            env!("RSIL_LONG_VERSION_1"),
            env!("RSIL_LONG_VERSION_2"),
            env!("RSIL_LONG_VERSION_3"),
            env!("RSIL_LONG_VERSION_4"),
        )),

        build_profile_name: Cow::Borrowed(env!("RSIL_BUILD_PROFILE")),
        p2p_client_version: Cow::Borrowed(env!("RSIL_P2P_CLIENT_VERSION")),
