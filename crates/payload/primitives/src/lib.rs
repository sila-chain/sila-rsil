...
pub fn validate_payload_timestamp(
    ...
    if version.is_v2() && is_cancun {
        ...
        //
        // This document defines how SilaCancun payload should be handled by the [`SilaShanghai
        // API`](https://github.com/sila-chain/execution-apis/blob/ff43500e653abde45aec0f545564abfb648317af/src/engine/shanghai.md).
        //
        // For the following methods:
        //
        // - [`engine_forkchoiceUpdatedV2`](https://github.com/sila-chain/execution-apis/blob/ff43500e653abde45aec0f545564abfb648317af/src/engine/shanghai.md#engine_forkchoiceupdatedv2)
        // - [`engine_newPayloadV2`](https://github.com/sila-chain/execution-apis/blob/ff43500e653abde45aec0f545564abfb648317af/src/engine/shanghai.md#engine_newpayloadV2)
        // - [`engine_getPayloadV2`](https://github.com/sila-chain/execution-apis/blob/ff43500e653abde45aec0f545564abfb648317af/src/engine/shanghai.md#engine_getpayloadv2)
        //
    ...
    if version.is_v3() && !is_cancun {
        // From the Engine API spec:
        // <https://github.com/sila-chain/execution-apis/blob/ff43500e653abde45aec0f545564abfb648317af/src/engine/cancun.md#specification-2>
        //
        // For `engine_getPayloadV3`:
        //
        // 1. Client software **MUST** return `-38005: Unsupported fork` error if the `timestamp` of
        //    the built payload does not fall within the time frame of the SilaCancun fork.
        //
        ...
        //    the time frame of the SilaCancun fork.
        //
    ...
    if version.is_v4() && !is_prague {
        // From the Engine API spec:
        // <https://github.com/sila-chain/execution-apis/blob/7907424db935b93c2fe6a3c0faab943adebe8557/src/engine/prague.md#specification-1>
        //
        // For `engine_getPayloadV4`:
        //
        // 1. Client software **MUST** return `-38005: Unsupported fork` error if the `timestamp` of
        //    the built payload does not fall within the time frame of the SilaPrague fork.
        //
        // For `engine_forkchoiceUpdatedV4`:
        //
        // 2. Client software **MUST** return `-38005: Unsupported fork` error if the
        //    `payloadAttributes` is set and the `payloadAttributes.timestamp` does not fall within
        //    the time frame of the SilaPrague fork.
        //
    ...
    if version.is_v5() && !is_osaka {
        // From the Engine API spec:
        // <https://github.com/sila-chain/execution-apis/blob/15399c2e2f16a5f800bf3f285640357e2c245ad9/src/engine/osaka.md#specification>
        //
...
pub fn validate_parent_beacon_block_root_presence<T: SilaHardforks>(
    chain_spec: &T,
    version: EngineApiMessageVersion,
    ...
    //    time frame of the SilaCancun fork.
    //
    // For `engine_newPayloadV3`:
    //
    // 2. Client software **MUST** return `-38005: Unsupported fork` error if the `timestamp` of the
...
/// Validates the presence or exclusion of fork-specific fields based on the sila execution
...
where
    ...
    T: SilaHardforks,
{
    // BAL only exists in ExecutionPayload, not PayloadAttributes (SIP-7928)
...
/// element is a `requests` byte array as defined by [SIP-7685](https://sips.sila.org/SIPS/sip-7685).
...
mod tests {
    ...
    fn validate_osaka_get_payload_restrictions() {
        ...
        // SilaOsaka is Active + V4 + Payload (NewPayload)
        let res = validate_payload_timestamp(
            &chain_spec,
            EngineApiMessageVersion::V4,
            osaka_activation,
