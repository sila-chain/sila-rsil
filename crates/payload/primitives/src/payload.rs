...
use alloc::vec::Vec;
use alloy_sips::{eip1898::BlockWithParent, eip4895::Withdrawal, eip7685::Requests, BlockNumHash};
    ...
    Serialize + DeserializeOwned + Debug + Clone + Send + Sync + 'static
{
    ...
    ///
    /// Returns `None` for pre-SilaShanghai blocks.
    fn withdrawals(&self) -> Option<&Vec<Withdrawal>>;

    /// Returns the access list included in this payload.
    ///
    /// Returns `None` for pre-SilaAmsterdam blocks.
...
/// Extended functionality for Sila execution payloads
