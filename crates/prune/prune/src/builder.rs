...
use rsil_config::PruneConfig;
use rsil_db_api::{table::Value, transaction::DbTxMut};
...
use rsil_storage_api::{ChangeSetReader, StorageChangeSetReader, StorageSettingsCache};
...
impl PrunerBuilder {
    ...
    pub fn new(pruner_config: PruneConfig) -> Self {
        ...
        if min_distance != rsil_prune_types::MINIMUM_UNWIND_SAFE_DISTANCE {
