...
use rsil_db_api::{table::Value, tables, transaction::DbTxMut};
...
use rsil_prune_types::{PruneCheckpoint, PruneSegment, SegmentOutput, SegmentOutputCheckpoint};
...
mod tests {
    ...
    fn prune_legacy() {
        ...
        db.factory = db.factory.with_prune_modes(rsil_prune_types::PruneModes {
