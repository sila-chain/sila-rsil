...
use rsil_provider::{BlockReader, PruneCheckpointReader, StaticFileProviderFactory};
...
mod tests {
    ...
    use rsil_prune_types::{PruneMode, PruneProgress, PruneSegment};
        ...
        if let Some(checkpoint_block) = test_case.tx_lookup_checkpoint_block {
            ...
            provider
                .save_prune_checkpoint(
                    ...
                    rsil_prune_types::PruneCheckpoint {
