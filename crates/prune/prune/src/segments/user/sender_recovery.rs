...
use rsil_db_api::{tables, transaction::DbTxMut};
use rsil_provider::{
...
mod tests {
    ...
    use rsil_prune_types::{PruneCheckpoint, PruneMode, PruneProgress, PruneSegment};
        ...
        test_prune(
            ...
            (
                PruneProgress::HasMoreData(
                    rsil_prune_types::PruneInterruptReason::DeletedEntriesLimitReached,
                ),
                10,
            ),
        );
