...
impl ExecutionWitnessRecord {
    ...
    ) -> rsil_storage_errors::provider::ProviderResult<alloy_rpc_types_debug::ExecutionWitness>
    where
        SP: rsil_storage_api::StateProofProvider + ?Sized,
        HP: rsil_storage_api::HeaderProvider + ?Sized,
