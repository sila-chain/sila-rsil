...
use rsil_trie_common::{updates::TrieUpdates, ExecutionWitnessMode, HashedPostState};
...
pub trait DebugApi<TxReq: RpcObject> {
    ...
    /// Returns an SIP-2718 binary-encoded transaction.
    ///
    ...
    /// Returns an array of SIP-2718 binary-encoded transactions for the given [`BlockId`].
    ...
    /// Returns the structured logs created during the execution of SAVM between two blocks
    ...
    /// Returns the structured logs created during the execution of SAVM against a block pulled
