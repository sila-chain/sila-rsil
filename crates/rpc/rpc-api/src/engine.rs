...
pub trait EngineApi<Engine: EngineTypes> {
    /// See also <https://github.com/sila-chain/execution-apis/blob/6709c2a795b707202e93c4f2867fa0bf2640a84f/src/engine/paris.md#engine_newpayloadv1>
    ...
    /// Post SilaCancun payload handler
    ///
    /// See also <https://github.com/sila-chain/execution-apis/blob/main/src/engine/cancun.md#engine_newpayloadv3>
    ...
    /// Post SilaPrague payload handler
    ///
    /// See also <https://github.com/sila-chain/execution-apis/blob/main/src/engine/prague.md#engine_newpayloadv4>
    ...
    /// See also <https://github.com/sila-chain/execution-apis/blob/6709c2a795b707202e93c4f2867fa0bf2640a84f/src/engine/paris.md#engine_forkchoiceupdatedv1>
    ///
    ...
    /// Post SilaShanghai forkchoice update handler
    ///
    ...
    ///
    /// See also <https://github.com/sila-chain/execution-apis/blob/6709c2a795b707202e93c4f2867fa0bf2640a84f/src/engine/shanghai.md#engine_forkchoiceupdatedv2>
    ///
    ...
    /// Post SilaCancun forkchoice update handler
    ///
    ...
    /// Post SilaAmsterdam forkchoice update handler
    ///
    ...
    /// the custody-column bitmask used for [SIP-8070] sparse blobpool signaling. It is
    ...
    /// See also <https://github.com/sila-chain/execution-apis/blob/6709c2a795b707202e93c4f2867fa0bf2640a84f/src/engine/paris.md#engine_getpayloadv1>
    ///
    ...
    /// See also <https://github.com/sila-chain/execution-apis/blob/6709c2a795b707202e93c4f2867fa0bf2640a84f/src/engine/shanghai.md#engine_getpayloadv2>
    ///
    /// Returns the most recent version of the payload that is available in the corresponding
    ...
    /// Post SilaCancun payload handler which also returns a blobs bundle.
    ///
    /// See also <https://github.com/sila-chain/execution-apis/blob/main/src/engine/cancun.md#engine_getpayloadv3>
    ///
    /// Returns the most recent version of the payload that is available in the corresponding
    /// payload build process at the time of receiving this call. Note:
    /// > Provider software MAY stop the corresponding build process after serving this call.
    ...
    /// Post SilaOsaka payload handler.
    ///
    ...
    /// See also:
    /// <https://github.com/sila-chain/execution-apis/blob/03911ffc053b8b806123f1fc237184b0092a485a/src/engine/identification.md#engine_getclientversionv1>
    ///
    ///
...
/// A subset of the SIL rpc interface: <https://sila.github.io/execution-apis/api-documentation>
///
/// This also includes additional sil functions required by optimism.
///
/// Specifically for the engine auth server: <https://github.com/sila-chain/execution-apis/blob/main/src/engine/common.md#underlying-protocol>
...
pub trait EngineEthApi<TxReq: RpcObject, B: RpcObject, R: RpcObject> {
    ...
    /// Returns the SIP-7928 block access list for a block by number.
    ...
    /// Returns the SIP-7928 block access list for a block by block id.
    #[method(name = "getBlockAccessList")]
    async fn block_access_list(&self, block_id: BlockId) -> RpcResult<Option<Value>>;

    /// Returns the SIP-7928 block access list bytes for a block by number.
