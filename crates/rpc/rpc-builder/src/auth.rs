...
pub use rsil_ipc::server::Builder as IpcServerBuilder;
...
impl<RpcMiddleware, HttpMiddleware> AuthServerConfigBuilder<RpcMiddleware, HttpMiddleware> {
    ...
    ///
    /// Note: this always configures an [`SilSubscriptionIdProvider`]
    /// [`IdProvider`](jsonrpsee::server::IdProvider) for convenience.
    pub fn with_server_config(mut self, config: ServerConfigBuilder) -> Self {
        self.server_config = Some(config.set_id_provider(SilSubscriptionIdProvider::default()));
        self
    }
        ...
        AuthServerConfig {
            ...
            server_config: self.server_config.unwrap_or_else(|| {
                ServerConfig::builder()
                    ...
                    .set_id_provider(SilSubscriptionIdProvider::default())
            }),
...
impl AuthServerHandle {
    ...
    pub async fn ipc_client(&self) -> Option<jsonrpsee::async_client::Client> {
        use rsil_ipc::client::IpcClientBuilder;
