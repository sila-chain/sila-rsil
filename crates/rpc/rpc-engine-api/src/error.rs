...
use rsil_engine_primitives::{BeaconForkChoiceUpdateError, BeaconOnNewPayloadError};
use rsil_payload_builder_primitives::PayloadBuilderError;
use rsil_payload_primitives::{EngineObjectValidationError, VersionSpecificValidationError};
use thiserror::Error;
...
/// the [Engine API spec](https://github.com/sila-chain/execution-apis/blob/main/src/engine/common.md#errors).
#[derive(Error, Debug)]
...
/// <https://github.com/sila-chain/execution-apis/blob/main/src/engine/common.md#errors>
...
impl From<EngineApiError> for jsonrpsee_types::error::ErrorObject<'static> {
    fn from(error: EngineApiError) -> Self {
        match error {
            // Per the SilaShanghai Engine API spec, FCU V2 must return -38003 when the wrong
            // PayloadAttributes version is used.
            // Spec: https://github.com/sila-chain/execution-apis/blob/main/src/engine/shanghai.md
            // Change: https://github.com/sila-chain/execution-apis/pull/761
