...
/// primarily intended for heavier blocking requests that require savm execution for example,
...
pub const DEFAULT_IPC_ENDPOINT: &str = "/tmp/rsil.ipc";

/// The `engine_api` IPC endpoint
pub const DEFAULT_ENGINE_API_IPC_ENDPOINT: &str = "/tmp/rsil_engine_api.ipc";
...
/// The default sil historical proof window.
pub const DEFAULT_ETH_PROOF_WINDOW: u64 = 0;

/// The default sil tx fee cap is 1 SIL
pub const DEFAULT_TX_FEE_CAP_WEI: u128 = 1_000_000_000_000_000_000u128;

/// Maximum sil historical proof window. Equivalent to roughly 6 months of data on a 12
...
pub mod gas_oracle {
    ...
    /// `SILA_BLOCK_GAS_LIMIT_30M` to allow for more complex calls.
    ...
    /// <https://github.com/sila-chain/go-sila/blob/a5a4fa7032bb248f5a7c40f4e8df2b131c4186a4/internal/ethapi/api.go#L56>
