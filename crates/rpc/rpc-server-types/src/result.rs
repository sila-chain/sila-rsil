...
impl_to_rpc_result!(rsil_errors::RsilError);
impl_to_rpc_result!(rsil_errors::ProviderError);
impl_to_rpc_result!(rsil_network_api::NetworkError);
...
mod tests {
    ...
    #[test]
    fn can_convert_rpc() {
        assert_rpc_result::<(), RsilError, RsilResult<()>>();

        let res = RsilResult::Ok(100);
