...
pub trait EstimateCall: Call {
        ...
        S: SavmStateProvider,
    {
        ...
        // <https://github.com/sila-chain/go-sila/pull/30695>
        ...
        // If SIP-8037 is enabled, the transaction gas limit cap is not applicable
        ...
        // Create SAVM instance once and reuse it throughout the entire estimation process
        let mut savm = self.evm_config().evm_with_env(&mut db, evm_env);
        ...
        trace!(target: "rpc::sil::estimate", ?tx_env, gas_limit = tx_env.gas_limit(), is_basic_transfer, "Starting gas estimation");

        // Execute the transaction with the highest possible gas limit.
        let mut res = match savm.transact(tx_env.clone()).map_err(Self::Error::from_evm_err) {
        ...
        let gas_refund = match res.result {
            ...
            ExecutionResult::Revert { output, .. } => {
                ...
                return if tx_request_gas_limit.is_some() || tx_request_gas_price.is_some() {
                    Self::map_out_of_gas_err(&mut savm, tx_env, max_gas_limit)
                } else {
        ...
        // <https://github.com/sila-chain/go-sila/blob/a5a4fa7032bb248f5a7c40f4e8df2b131c4186a4/sil/gasestimator/gasestimator.go#L135
        //
        ...
        if optimistic_gas_limit < highest_gas_limit {
            ...
            // environment.
            res = savm.transact(optimistic_tx_env).map_err(Self::Error::from_evm_err)?;
        ...
        trace!(target: "rpc::sil::estimate", ?highest_gas_limit, ?lowest_gas_limit, ?mid_gas_limit, "Starting binary search for gas");
        ...
        while lowest_gas_limit + 1 < highest_gas_limit {
            ...
            match savm.transact(mid_tx_env).map_err(Self::Error::from_evm_err) {
    ...
    fn map_out_of_gas_err<DB>(
        savm: &mut SavmFor<Self::Savm, DB>,
        mut tx_env: TxEnvFor<Self::Savm>,
        max_gas_limit: u64,
    ) -> Result<U256, Self::Error>
    where
        ...
        SilApiError: From<DB::Error>,
    {
        ...
        let retry_res = savm.transact(tx_env).map_err(Self::Error::from_evm_err)?;
...
pub fn update_estimated_gas_range<Halt>(
    ...
    match result {
        ...
        ExecutionResult::Revert { .. } | ExecutionResult::Halt { .. } => {
            ...
            // <https://github.com/OpenZeppelin/openzeppelin-contracts/blob/94697be8a3f0dfcd95dfb13ffbd39b5973f5c65d/contracts/metatx/SRC2771Forwarder.sol#L360-L367>
