...
use rsil_rpc_server_types::constants::cache::{
...
/// Settings for the [`SilStateCache`](super::SilStateCache).
#[derive(Debug, Clone, Copy, Eq, PartialEq, Serialize, Deserialize)]
#[serde(rename_all = "camelCase")]
pub struct SilStateCacheConfig {
...
impl Default for SilStateCacheConfig {
    fn default() -> Self {
        Self {
