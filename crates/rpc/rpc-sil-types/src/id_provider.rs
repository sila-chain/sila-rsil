...
/// An [`IdProvider`](jsonrpsee_core::traits::IdProvider) for sila subscription ids.
///
/// Returns new hex-string [QUANTITY](https://sila.org/en/developers/docs/apis/json-rpc/#quantities-encoding) ids
#[derive(Debug, Clone, Copy, Default)]
#[non_exhaustive]
pub struct SilSubscriptionIdProvider;

impl jsonrpsee_core::traits::IdProvider for SilSubscriptionIdProvider {
