...
/// Converter for Sila receipts.
#[derive(derive_more::Debug)]
pub struct SilReceiptConverter<
    ChainSpec,
...
impl<ChainSpec, Builder> Clone for SilReceiptConverter<ChainSpec, Builder>
where
    Builder: Clone,
{
    fn clone(&self) -> Self {
...
impl<ChainSpec> SilReceiptConverter<ChainSpec> {
    ...
    pub fn with_builder<Builder>(
        self,
        build_rpc_receipt: Builder,
    ) -> SilReceiptConverter<ChainSpec, Builder> {
        SilReceiptConverter { chain_spec: self.chain_spec, build_rpc_receipt }
    }
}

impl<N, ChainSpec, Builder, Rpc> ReceiptConverter<N> for SilReceiptConverter<ChainSpec, Builder>
where
    N: NodePrimitives,
    ChainSpec: SilChainSpec + 'static,
