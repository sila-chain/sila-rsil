...
/// - Compares the computed Block Access List Hash to the value in the header if SilaAmsterdam is active
///
...
/// Validate a block with regard to execution results, optionally allowing pre-SilaAmsterdam BAL hashes.
    ...
    ChainSpec: SilaHardforks,
{
    ...
    // See more about SIP here: https://sips.sila.org/SIPS/sip-658
