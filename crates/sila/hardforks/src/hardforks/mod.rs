...
impl ChainHardforks {
    ...
    ///
    /// Equivalent Sila hardforks **must be included** as well.
    ...
    /// forks.insert(Fork::SilaCancun, ForkCondition::Timestamp(1710338135));
    ///
    /// // Forks are ordered: Frontier (Block 0), Homestead (Block 1150000), SilaCancun (Timestamp)
    /// ```
    ...
    ///     (Fork::SilaCancun, ForkCondition::Timestamp(1710338135)),
    /// ]);
    ///
    /// // Forks will be automatically ordered: Frontier, Homestead, SilaCancun
    /// ```
