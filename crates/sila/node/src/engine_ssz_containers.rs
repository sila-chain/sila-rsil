...
//! [execution-apis PR #793](https://github.com/sila-chain/execution-apis/pull/793), plus the
...
///
/// This differs from [`Option<T>`]'s `sila_ssz` encoding, which uses an SSZ union.
...
/// SilaShanghai payload attributes.
#[derive(Clone, Debug, Default, PartialEq, Eq, ssz_derive::Encode, ssz_derive::Decode)]
...
/// SilaPrague uses the SilaCancun payload-attributes schema.
pub type PayloadAttributesPrague = PayloadAttributesCancun;

/// SilaOsaka uses the SilaCancun payload-attributes schema.
pub type PayloadAttributesOsaka = PayloadAttributesCancun;

/// SilaAmsterdam payload attributes.
#[derive(Clone, Debug, Default, PartialEq, Eq, ssz_derive::Encode, ssz_derive::Decode)]
...
/// This structure maps to the Engine API v2 REST-SSZ payload-build response for SilaParis.
///
...
/// This structure maps to the Engine API v2 REST-SSZ payload-build response for SilaShanghai.
///
/// This follows the legacy `engine_getPayloadV2` payload-build response shape: execution payload
/// plus block value only. `should_override_builder` starts at SilaCancun.
#[derive(Clone, Debug, PartialEq, Eq, ssz_derive::Encode, ssz_derive::Decode)]
...
/// Engine API v2 REST-SSZ payload-build response for SilaCancun.
///
...
/// This structure maps to the Engine API v2 REST-SSZ payload-build response for SilaPrague.
///
...
pub struct BuiltPayloadPrague {
    ...
    /// A list of opaque SIP-7685 requests.
...
/// This structure maps to the Engine API v2 REST-SSZ payload-build response for SilaOsaka.
#[derive(Clone, Debug, PartialEq, Eq, ssz_derive::Encode, ssz_derive::Decode)]
pub struct BuiltPayloadOsaka {
    ...
    /// The expected value to be received by the fee recipient in wei.
    pub block_value: U256,
    /// The blobs, commitments, and SIP-7594 cell proofs associated with the executed payload.
...
/// This structure maps to the Engine API v2 REST-SSZ payload-build response for SilaAmsterdam.
#[derive(Clone, Debug, PartialEq, Eq, ssz_derive::Encode, ssz_derive::Decode)]
    ...
    fn try_from(value: LegacyBuiltPayloadShanghai) -> Result<Self, Self::Error> {
        match value.execution_payload {
            ...
            ExecutionPayloadFieldV2::V1(_) => {
                Err(BuiltPayloadConversionError::UnexpectedPayloadFork("SilaParis"))
            }
        }
    }
}
...
///
/// SilaParis payload-submission request.
#[derive(Clone, Debug, PartialEq, Eq, ssz_derive::Encode, ssz_derive::Decode)]
...
/// SilaShanghai payload-submission request.
#[derive(Clone, Debug, PartialEq, Eq, ssz_derive::Encode, ssz_derive::Decode)]
...
/// SilaCancun payload-submission request.
#[derive(Clone, Debug, PartialEq, Eq, ssz_derive::Encode, ssz_derive::Decode)]
...
/// SilaPrague payload-submission request.
#[derive(Clone, Debug, PartialEq, Eq, ssz_derive::Encode, ssz_derive::Decode)]
pub struct ExecutionPayloadEnvelopePrague {
    ...
    /// Root of the parent beacon block.
    pub parent_beacon_block_root: B256,
    /// SIP-7685 execution requests.
    pub execution_requests: Requests,
}

/// SilaOsaka payload-submission request.
#[derive(Clone, Debug, PartialEq, Eq, ssz_derive::Encode, ssz_derive::Decode)]
...
/// SilaAmsterdam payload-submission request.
#[derive(Clone, Debug, PartialEq, Eq, ssz_derive::Encode, ssz_derive::Decode)]
