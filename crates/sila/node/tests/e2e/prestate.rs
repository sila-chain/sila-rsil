...
/// Replays the selfdestruct transaction via `debug_traceCall` and ensures Rsil's prestate matches
/// Geth's captured snapshot.
// <https://github.com/sila-chain/sila-rsil/issues/19703>
#[tokio::test]
async fn debug_trace_call_matches_geth_prestate_snapshot() -> Result<()> {
    rsil_tracing::init_test_tracing();

    let mut genesis: Genesis = SILA_MAINNET.genesis().clone();
    ...
    // <https://silascan.io/tx/0x391f4b6a382d3bcc3120adc2ea8c62003e604e487d97281129156fd284a1a89d>
    let tx = r#"{
        "type": "0x2",
        "chainId": "0x1",
        "nonce": "0x39af8",
