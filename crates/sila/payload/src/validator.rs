//! Validates execution payload wrt Sila consensus rules

use alloy_consensus::Block;
use alloy_rpc_types_engine::{ExecutionData, PayloadError};
use rsil_chainspec::SilaHardforks;
use rsil_payload_validator::{cancun, prague, shanghai};
use rsil_primitives_traits::{Block as _, SealedBlock, SignedTransaction};
use std::sync::Arc;

/// Execution payload validator.
#[derive(Clone, Debug)]
pub struct SilaExecutionPayloadValidator<ChainSpec> {
    /// Chain spec to validate against.
    chain_spec: Arc<ChainSpec>,
}

impl<ChainSpec> SilaExecutionPayloadValidator<ChainSpec> {
...
impl<ChainSpec: SilaHardforks> SilaExecutionPayloadValidator<ChainSpec> {
...
/// The additional [`MaybeCancunPayloadFields`](alloy_rpc_types_engine::MaybeCancunPayloadFields) are not part of the payload, but are additional fields in the `engine_newPayloadV3` RPC call, See also <https://github.com/sila-chain/execution-apis/blob/fe8e13c288c592ec154ce25c534e26cb7ce0530d/src/engine/cancun.md#engine_newpayloadv3>
///
...
///
/// This validates versioned hashes according to the Engine API SilaCancun spec:
/// <https://github.com/sila-chain/execution-apis/blob/fe8e13c288c592ec154ce25c534e26cb7ce0530d/src/engine/cancun.md#specification>
