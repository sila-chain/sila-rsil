...
/// Raw sila receipt.
pub type Receipt<T = TxType> = SilaReceipt<T>;

#[cfg(feature = "rpc")]
/// Receipt representation for RPC.
pub type RpcReceipt<T = TxType> = SilaReceipt<T, alloy_rpc_types_sil::Log>;
...
mod tests {
    ...
    fn check_withdrawals_root() {
        ...
        // https://github.com/sila-chain/tests/blob/9760400e667eba241265016b02644ef62ab55de2/BlockchainTests/EIPTests/bc4895-withdrawals/amountIs0.json
        let data = &hex!(
        ...
        // https://github.com/sila-chain/tests/blob/9760400e667eba241265016b02644ef62ab55de2/BlockchainTests/EIPTests/bc4895-withdrawals/twoIdenticalIndex.json
        let data = &hex!(
    ...
    // Ensures that rsil and alloy receipts encode to the same JSON
    #[test]
    #[cfg(feature = "rpc")]
    fn test_receipt_serde() {
        ...
        let envelope: ReceiptEnvelope<alloy_rpc_types_sil::Log> =
