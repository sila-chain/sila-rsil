...
//! instance of rsil.
//!
//! It is also possible to run parts of rsil standalone given the required data is present in
...
//! # use rsil_stages::sets::{OfflineStages};
...
//!
//! # fn create(exec: impl ConfigureEvm<Primitives = SilPrimitives> + 'static, consensus: impl FullConsensus<SilPrimitives> + 'static) {
//!
...
use rsil_consensus::FullConsensus;
use rsil_evm::ConfigureEvm;
use rsil_network_p2p::{bodies::downloader::BodyDownloader, headers::downloader::HeaderDownloader};
use rsil_primitives_traits::{Block, NodePrimitives};
use rsil_provider::HeaderSyncGapProvider;
use rsil_prune_types::{PruneMode, PruneModes};
use rsil_stages_api::Stage;
use std::sync::Arc;
use tokio::sync::watch;

/// A set containing all stages to run a fully syncing instance of rsil.
///
