...
use rsil_config::config::{EtlConfig, IndexHistoryConfig};
use rsil_db_api::{
...
use rsil_prune_types::{PruneCheckpoint, PruneMode, PrunePurpose, PruneSegment};
use rsil_stages_api::{ExecInput, ExecOutput, Stage, StageError, UnwindInput, UnwindOutput};
use std::fmt::Debug;
use tracing::info;
...
where
    Provider: DBProvider<Tx: DbTxMut>
        ...
        + rsil_provider::NodePrimitivesProvider,
{
    ...
    fn execute(
        ...
        provider.with_rocksdb_batch_auto_commit(|rocksdb_batch| {
            ...
            load_storage_history(collector, first_sync, &mut writer)
                .map_err(|e| rsil_provider::ProviderError::other(Box::new(e)))?;
...
mod tests {
    ...
    use rsil_provider::{providers::StaticFileWriter, DatabaseProviderFactory};
    ...
    mod rocksdb_tests {
        use super::*;
        use rsil_db_api::models::StorageBeforeTx;
        use rsil_provider::{providers::StaticFileWriter, RocksDBProviderFactory};
        use rsil_static_file_types::StaticFileSegment;
        use rsil_storage_api::StorageSettings;
        ...
        async fn unwind_multi_shard() {
            use rsil_db_api::models::sharded_key::NUM_OF_INDICES_IN_SHARD;
