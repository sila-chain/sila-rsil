...
use rsil_storage_api::{ChangeSetReader, StorageChangeSetReader};
...
where
    N: NodePrimitives,
    CURSOR: DbCursorRW<rsil_db_api::tables::AccountsHistory>
        + DbCursorRO<rsil_db_api::tables::AccountsHistory>,
{
...
where
    N: NodePrimitives,
    CURSOR: DbCursorRW<rsil_db_api::tables::StoragesHistory>
        + DbCursorRO<rsil_db_api::tables::StoragesHistory>,
{
