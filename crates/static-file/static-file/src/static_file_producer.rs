...
use rsil_static_file_types::{HighestStaticFiles, StaticFileTargets};
        ...
        >,
{
    ...
    /// runs it with the provided block range using [`rsil_provider::providers::StaticFileProvider`]
    ...
    /// [stage checkpoints](rsil_stages_types::StageCheckpoint).
    ///
    ...
    /// [`rsil_provider::providers::StaticFileProvider::get_highest_static_files`].
...
mod tests {
    ...
    use rsil_static_file_types::{HighestStaticFiles, StaticFileSegment};
