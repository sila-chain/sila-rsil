...
use rsil_primitives_traits::{Account, ValueWithSubKey};
...
// NOTE: Removing rsil_codec and manually encode subkey
// and compress second part of the value. If we have compression
// over whole value (Even SubKey) that would mess up fetching of values with seek_by_key_subkey
#[cfg(any(test, feature = "rsil-codec"))]
impl rsil_codecs::Compact for AccountBeforeTx {
...
#[cfg(any(test, feature = "rsil-codec"))]
rsil_codecs::impl_compression_for_compact!(AccountBeforeTx);
