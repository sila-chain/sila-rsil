...
use rsil_libmdbx::{Error as MDBXError, TransactionKind, WriteFlags, RO, RW};
use rsil_storage_errors::db::{DatabaseErrorInfo, DatabaseWriteError, DatabaseWriteOperation};
...
pub struct Cursor<K: TransactionKind, T: Table> {
    ...
    pub(crate) inner: rsil_libmdbx::Cursor<K>,
