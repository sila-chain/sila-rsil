...
impl<N> ProviderFactoryBuilder<N> {
    /// Maps the [`rsil_node_types::NodeTypes`] of this builder.
    ...
    /// use rsil_provider::providers::{NodeTypesForProvider, ProviderFactoryBuilder};
    ///
    /// fn demo<N: NodeTypesForProvider<ChainSpec = rsil_chainspec::ChainSpec>>(
    ...
    /// ```no_run
    /// use rsil_chainspec::SILA_MAINNET;
    /// use rsil_provider::providers::{NodeTypesForProvider, ProviderFactoryBuilder, ReadOnlyConfig};
    ///
    /// fn demo<N: NodeTypesForProvider<ChainSpec = rsil_chainspec::ChainSpec>>(
    ///     runtime: rsil_tasks::Runtime,
    /// ) {
