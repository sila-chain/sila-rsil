...
mod tests {
    ...
    use rsil_db::{models::AccountBeforeTx, test_utils::create_test_static_files_dir};
    use rsil_primitives_traits::Account;
    use rsil_static_file_types::{ChangesetOffset, ChangesetOffsetReader, StaticFileSegment};
    ...
    fn setup_test_provider(
        ...
        blocks_per_file: u64,
    ) -> StaticFileProvider<SilPrimitives> {
    ...
    fn write_test_blocks(
        provider: &StaticFileProvider<SilPrimitives>,
        num_blocks: u64,
    ...
    fn get_sidecar_path(provider: &StaticFileProvider<SilPrimitives>, block: u64) -> PathBuf {
    ...
    fn get_header_block_count(provider: &StaticFileProvider<SilPrimitives>, block: u64) -> u64 {
    ...
    fn get_nippy_row_count(provider: &StaticFileProvider<SilPrimitives>, block: u64) -> u64 {
        let jar_provider = provider
            .get_segment_provider_for_block(StaticFileSegment::AccountChangeSets, block, None)
            .unwrap();
