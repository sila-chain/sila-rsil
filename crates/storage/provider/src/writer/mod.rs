...
mod tests {
    ...
    use rsil_trie_db::{DatabaseStateRoot, DatabaseStorageRoot, LegacyKeyAdapter, PackedKeyAdapter};
    use revm::database::{
        states::{
    ...
    use revm::state::{
        Account as RevmAccount, AccountInfo as RevmAccountInfo, AccountStatus, SavmStorageSlot,
    };
    ...
    fn write_to_db_account_info() {
        ...
        let rsil_account_a = account_a.into();
        let rsil_account_b = account_b.into();
        let rsil_account_b_changed = (&account_b_changed).into();
        ...
        assert_eq!(
            ...
            Some((1, AccountBeforeTx { address: address_b, info: Some(rsil_account_b) })),
        ...
        assert_eq!(
            ...
            Some((2, AccountBeforeTx { address: address_b, info: Some(rsil_account_b_changed) })),
            ...
            (
                ...
                RevmAccount {
                    ...
                    storage: HashMap::from_iter([
                        (
                            U256::from(0),
                            SavmStorageSlot { present_value: U256::from(1), ..Default::default() },
                        ),
                        (
                            U256::from(1),
                            SavmStorageSlot { present_value: U256::from(2), ..Default::default() },
                        ),
                    ]),
                    transaction_id: 0,
                },
    ...
    fn write_to_db_multiple_selfdestructs() {
        ...
        state.commit(HashMap::from_iter([(
            ...
            RevmAccount {
                ...
                storage: HashMap::from_iter([
                    ...
                    (
                        U256::from(2),
                        SavmStorageSlot { present_value: U256::from(4), ..Default::default() },
                    ),
                    (
                        U256::from(6),
                        SavmStorageSlot { present_value: U256::from(6), ..Default::default() },
                    ),
                ]),
                transaction_id: 0,
            },
        ...
        state.commit(HashMap::from_iter([(
            ...
            RevmAccount {
                ...
                storage: HashMap::from_iter([(
                    U256::ZERO,
                    SavmStorageSlot { present_value: U256::from(9), ..Default::default() },
                )]),
                transaction_id: 0,
            },
        )]));
    ...
    fn storage_change_after_selfdestruct_within_block() {
        ...
        state.commit(HashMap::from_iter([(
            ...
            RevmAccount {
                ...
                storage: HashMap::from_iter([(
                    U256::from(1),
                    SavmStorageSlot { present_value: U256::from(5), ..Default::default() },
                )]),
                transaction_id: 0,
            },
        )]));
    ...
    fn bundle_state_state_root() {
        ...
        state.commit(HashMap::from_iter([(
            ...
            RevmAccount {
                ...
                storage: HashMap::from_iter([(
                    slot20,
                    SavmStorageSlot::new_changed(U256::ZERO, account1_slot20_value, 0),
                )]),
                transaction_id: 0,
            },
        )]));
