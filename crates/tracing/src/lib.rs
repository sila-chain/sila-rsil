...
//!  ```
//!  use rsil_tracing::{
//!      LayerInfo, RsilTracer, Tracer,
//!      tracing::level_filters::LevelFilter,
//!      LogFormat,
//!  };
//!
//!  fn main() -> eyre::Result<()> {
//!      let tracer = RsilTracer::new().with_stdout(LayerInfo::new(
//!          LogFormat::Json,
