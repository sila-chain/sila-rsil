...
/// A blob store that can be used to store blob data of SIP4844 transactions.
///
...
pub trait BlobStore: fmt::Debug + Send + Sync + 'static {
    ...
    /// cell proofs in [`BlobAndProofV2`] supported by the SIP-7594 blob sidecar variant.
    ///
    ...
    /// e.g. where v1 would return `[A, None, C]` v2 would return `None`. See also <https://github.com/sila-chain/execution-apis/blob/main/src/engine/osaka.md#engine_getblobsv2>
