...
use rsil_execution_types::ChainBlocks;
use rsil_primitives_traits::{Block, BlockBody, SignedTransaction};
...
mod tests {
    ...
    fn test_add_new_chain_blocks() {
        ...
        // Creating a first block with SIP-4844 transactions
        ...
        // Creating a second block with SIP-1559 and SIP-2930 transactions
        // Note: This block does not contain any SIP-4844 transactions
        ...
        // Tx1 and tx2 should be in the block containing SIP-4844 transactions
        assert_eq!(tracker.blob_txs_in_blocks.get(&10).unwrap(), &vec![tx1_hash, tx2_hash]);
        // No transactions should be in the block containing non-SIP-4844 transactions
