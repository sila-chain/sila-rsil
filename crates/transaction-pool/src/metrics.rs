...
pub struct TxPoolMetrics {
    ...
    /// Number of all SIP-2930 transactions in the pool
    pub total_eip2930_transactions: Gauge,
    /// Number of all SIP-1559 transactions in the pool
    pub total_eip1559_transactions: Gauge,
    /// Number of all SIP-4844 transactions in the pool
    pub total_eip4844_transactions: Gauge,
    /// Number of all SIP-7702 transactions in the pool
