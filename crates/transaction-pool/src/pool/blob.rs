...
pub struct BlobTransactions<T: PoolTransaction> {
    ...
    ///
    /// See also [`rsil_primitives_traits::InMemorySize::size`].
    size_of: SizeTracker,
}
...
/// would be the priority fee for the SIP1559 component of transaction fees, and the blob fee cap
/// for the blob component of transaction fees.
///
/// The `current_fee` is the current value of the fee, this would be the base fee for the SIP1559
...
mod tests {
    ...
    fn test_blob_ordering() {
        // Tests are from:
        // <https://github.com/sila-chain/go-sila/blob/e91cdb49beb4b2a3872b5f2548bf2d6559e4f561/core/txpool/blobpool/evictheap_test.go>
    ...
    fn priority_tests() {
        // Test vectors from:
        // <https://github.com/sila-chain/go-sila/blob/e91cdb49beb4b2a3872b5f2548bf2d6559e4f561/core/txpool/blobpool/priority_test.go#L27-L49>
        let vectors = vec![
            (7u128, 10u128, 2i64),
    ...
    fn test_transaction_removal() {
        ...
        // Add a transaction
        let tx = factory.validated_arc(MockTransaction::sip4844());
        let tx_id = *tx.id();
    ...
    fn test_add_non_blob_transaction() {
        ...
        let mut factory = MockTransactionFactory::default();
        let mut pool = BlobTransactions::default();
        let tx = factory.validated_arc(MockTransaction::sip1559()); // Not a blob transaction
        pool.add_transaction(tx);
    }
    ...
    fn test_remove_transactions_until_limit() {
        ...
        let mut factory = MockTransactionFactory::default();
        let mut pool = BlobTransactions::default();
        let tx1 = factory.validated_arc(MockTransaction::sip4844().with_size(100));
        let tx2 = factory.validated_arc(MockTransaction::sip4844().with_size(200));
        let tx3 = factory.validated_arc(MockTransaction::sip4844().with_size(300));
