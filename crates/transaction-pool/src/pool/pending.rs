...
mod tests {
    ...
    fn evict_worst() {
        ...
        let t = MockTransaction::sip1559();
        pool.add_transaction(f.validated_arc(t.clone()), 0);

        let t2 = MockTransaction::sip1559().inc_price_by(10);
    ...
    // <https://github.com/sila-chain/sila-rsil/issues/12340>
    #[test]
    ...
    fn test_reorder_on_basefee_update() {
        ...
        let tx2 = f.validated_arc(MockTransaction::sip1559().inc_price_by(20));
    ...
    fn test_update_blob_fee() {
        ...
        let tx1 = f.validated_arc(MockTransaction::sip4844().set_blob_fee(50).clone());
        let tx2 = f.validated_arc(MockTransaction::sip4844().set_blob_fee(150).clone());
        pool.add_transaction(tx1.clone(), 0);
        pool.add_transaction(tx2.clone(), 0);
