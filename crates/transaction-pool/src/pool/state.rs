...
bitflags::bitflags! {
    ...
    /// - If it is an SIP-4844 blob transaction it belongs in the blob sub-pool: [SubPool::Blob].
    ...
    pub(crate) struct TxState: u8 {
        ...
        /// Covers the dynamic blob fee requirement, only relevant for SIP-4844 blob transactions.
        ///
...
impl TxState {
    ...
    /// requirement. With SIP-1559, transactions can become executable or not without any changes to
