...
//!
//! Sila block transaction and receipt roots are ordered trie roots keyed by the RLP encoding of
//! each item index.
...
//!
//! ```
//! use rsil_trie_common::ordered_root::OrderedTrieRootEncodedBuilder;
//!
        ...
        proptest! {
            ...
            fn arbitrary_receipts_match_alloy_consensus_root(
                receipts in proptest::collection::vec(
                    arb::<ReceiptWithBloom<SilaReceipt>>(),
                    0..1024,
                ),
            ) {
