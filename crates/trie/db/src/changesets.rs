...
use rsil_trie_common::updates::{StorageTrieUpdatesSorted, TrieUpdatesSorted};
use std::{
...
#[cfg(test)]
use rsil_trie::changesets::compute_trie_changesets;
...
mod tests {
    ...
    use rsil_storage_api::{StageCheckpointWriter, TrieWriter};
    use rsil_trie::{BranchNodeCompact, Nibbles, StateRoot};
