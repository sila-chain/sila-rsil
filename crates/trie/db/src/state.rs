...
pub trait DatabaseStateRoot<'a, TX>: Sized {
    ...
    /// use rsil_db_api::database::Database;
    /// use rsil_primitives_traits::Account;
    /// use rsil_trie::{updates::TrieUpdates, HashedPostState, StateRoot};
    /// use rsil_trie_db::{DatabaseStateRoot, LegacyKeyAdapter};
    ///
    ...
    ///     rsil_trie_db::DatabaseTrieCursorFactory<_, LegacyKeyAdapter>,
    ///     rsil_trie_db::DatabaseHashedCursorFactory<_>,
...
mod tests {
    ...
    fn from_reverts_with_hashed_state() {
        ...
        use rsil_provider::{StaticFileProviderFactory, StaticFileSegment, StaticFileWriter};
