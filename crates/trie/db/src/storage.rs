...
use rsil_db_api::{models::BlockNumberAddress, transaction::DbTx};
use rsil_execution_errors::StorageRootError;
use rsil_storage_api::{BlockNumReader, StorageChangeSetReader};
...
#[cfg(feature = "metrics")]
use rsil_trie::metrics::TrieRootMetrics;
    ...
    for StorageRoot<DatabaseTrieCursorFactory<&'a TX, A>, DatabaseHashedCursorFactory<&'a TX>>
{
    fn from_tx(tx: &'a TX, address: Address) -> Self {
        Self::new(
            ...
            Default::default(),
            #[cfg(feature = "metrics")]
            TrieRootMetrics::new(rsil_trie::TrieType::Storage),
        )
    }
...
mod tests {
    ...
    use rsil_db_api::{models::BlockNumberAddress, tables, transaction::DbTxMut};
    ...
    fn append_storage_changesets_to_static_files(
        factory: &impl StaticFileProviderFactory<
            Primitives: rsil_primitives_traits::NodePrimitives<BlockHeader = Header>,
        >,
        changesets: Vec<(u64, Vec<rsil_db_api::models::StorageBeforeTx>)>,
    ) {
    ...
    fn test_hashed_storage_from_reverts_hashed_state() {
        use rsil_db_api::models::{StorageBeforeTx, StorageSettings};
