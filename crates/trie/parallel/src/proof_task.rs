...
use rsil_execution_errors::StateProofError;
use rsil_primitives_traits::{dashmap::DashMap, FastInstant as Instant};
use rsil_provider::{DatabaseProviderROFactory, ProviderError, ProviderResult};
...
mod tests {
    ...
    use rsil_provider::test_utils::create_test_provider_factory_with_chain_spec;
    use std::sync::Arc;
    ...
    fn spawn_proof_workers_creates_handle() {
        ...
        let changeset_cache = rsil_trie_db::ChangesetCache::new();
        let factory = rsil_provider::providers::OverlayStateProviderFactory::new(
            provider_factory,
            rsil_provider::providers::OverlayBuilder::<rsil_sila_primitives::SilPrimitives>::new(
                anchor_hash,
                changeset_cache,
            ),
        );
