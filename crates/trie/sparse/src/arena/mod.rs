...
use rsil_execution_errors::SparseTrieResult;
...
mod tests {
    ...
    use rsil_trie_common::{Nibbles, ProofV2Target};
    ...
    impl ArenaTrieTestHarness {
        ...
        fn assert_changes(
            ...
            // due to the crate's SparseTrieUpdates being a different type than rsil-trie's copy).
