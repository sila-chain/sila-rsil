...
impl ProofTrieNodeRecord {
    /// Creates a record from a [`rsil_trie_common::ProofTrieNode`].
    pub fn from_proof_trie_node(node: &rsil_trie_common::ProofTrieNode) -> Self {
        Self {
            path: node.path,
    ...
    /// Creates a record from a [`rsil_trie_common::ProofTrieNodeV2`].
    pub fn from_proof_trie_node_v2(node: &rsil_trie_common::ProofTrieNodeV2) -> Self {
        use rsil_trie_common::TrieNodeV2;
