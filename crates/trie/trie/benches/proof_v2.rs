...
use rsil_trie_common::{HashedPostState, HashedStorage};
...
fn create_cursor_factories(
    ...
    use rsil_trie::{updates::StorageTrieUpdates, StateRoot};
    ...
    let empty_trie_cursor_factory =
        MockTrieCursorFactory::from_trie_updates(rsil_trie_common::updates::TrieUpdates {
