...
* [`Sentry`](https://docs.erigon.tech/fundamentals/modules/sentry), a pluggable p2p node following the [Erigon gRPC architecture](https://erigon.substack.com/p/current-status-of-silkworm-and-silkrpc):
    ...
    * The code from rust-sila/devp2p was merged into sentry, and rust-sila/devp2p was archived
...
* [`Ranger`](https://github.com/Rjected/ranger), an sila p2p client capable of interacting with peers without a full node:
    ...
    * It also required creating [`ethp2p`](https://github.com/Rjected/ethp2p), a clean room implementation of the [sil wire](https://github.com/sila-chain/devp2p/blob/master/caps/sil.md) protocol, for use in ranger.
