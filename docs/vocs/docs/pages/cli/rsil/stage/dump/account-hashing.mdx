# rsil stage dump account-hashing

`AccountHashing` stage

```bash
$ rsil stage dump account-hashing --help
```
```txt
Usage: rsil stage dump account-hashing [OPTIONS] --output-datadir <OUTPUT_PATH> --from <FROM> --to <TO>
