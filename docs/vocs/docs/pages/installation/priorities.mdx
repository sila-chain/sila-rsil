---
description: Explains Rsil update priorities for user classes such as payload builders and non-payload builders.
---

# Update Priorities

When publishing releases, rsil will include an "Update Priority" section in the release notes, in the same manner Lighthouse does.
...
-   _Payload builders_ are those who use rsil to build and validate payloads.
-   _Non-payload builders_ are those who run rsil for other purposes (e.g., data analysis, RPC or applications).
