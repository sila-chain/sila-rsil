...
Rsil has docs specifically geared for developers and contributors, including documentation on the structure and architecture of rsil, the general workflow we employ, and other useful tips.

## Getting Help

Need support or have questions? Open a github issue and/or join the TG chat:

-   **GitHub Issues**: [Open an issue](https://github.com/sila-chain/sila-rsil/issues/new) for bugs or feature requests
-   **Telegram Chat**: [Join our Telegram](https://t.me/paradigm_rsil) for real-time support and discussions

## Repository and Project Structure

Rsil is organized as a modular codebase with clear separation and a contributor friendly architecture, you can read about it in detail [here](https://github.com/sila-chain/sila-rsil/tree/main/docs). Here's the TL;DR:

### Design

Rsil follows a modular architecture where each component can be used independently:
...
├── sila/          # Sila-specific implementations
└── ...
```
...
```bash
# Clone your fork
git clone https://github.com/YOUR_USERNAME/rsil.git
cd rsil
...
Rsil uses comprehensive testing at multiple levels:
...
```bash
cargo test --package rsil-sila-consensus
```
...
Run all tests including Sila Foundation tests:
...
3. **Testing**: Final validation on testnet and sila-mainnet
...
Rsil follows the [Rust Code of Conduct](https://www.rust-lang.org/conduct.html). We are committed to providing a welcoming and inclusive environment for all contributors.
...
:::note
Also read [CONTRIBUTING.md](https://github.com/sila-chain/sila-rsil/blob/main/CONTRIBUTING.md) for in-depth guidelines.
:::
