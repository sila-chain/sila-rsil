...
The consensus component validates blocks according to Sila protocol rules, handles chain reorganizations, and manages the canonical chain state.
...
- Validating blob transactions (SIP-4844)
...
- **Withdrawals root**: For post-SilaShanghai blocks
- **Blob validation**: For SIP-4844 transactions
...
- Explore [SAVM](/sdk/node-components/savm) execution
