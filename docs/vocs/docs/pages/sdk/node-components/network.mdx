...
The network component handles all peer-to-peer communication in Rsil, including peer discovery, connection management, and protocol message handling.

## Overview

The network stack implements the Sila Wire Protocol (SIL) and provides:
...
### Protocol Support
- **SIL Protocol**: Core Sila wire protocol for blocks and transactions
