import { rsilCliSidebar } from "./sidebar-cli-rsil";
...
export const sidebar: SidebarItem[] = [
    ...
    {
        text: "Interacting with Rsil over JSON-RPC",
