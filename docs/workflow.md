...
- Features and bug fixes live on feature branches off of the main branch, and they are merged onto main as well.  
  This means that the latest version of rsil (which might be unstable) always lives on main.
...
- Important pull requests that should be highlighted in the changelog should be marked with the https://github.com/sila-chain/sila-rsil/labels/M-changelog label.
