...
These examples demonstrate the main features of some of Rsil's crates and how to use them.
...
| [Custom SAVM](./custom-savm)                          | Illustrates how to implement a node with a custom SAVM                                            |
| [Custom Precompile Cache](./precompile-cache)       | Illustrates how to implement a node with a stateful precompile cache                             |
| [Custom inspector](./custom-inspector)              | Illustrates how to use a custom SAVM inspector to trace new transactions                          |
...
See examples in a [dedicated repository](https://github.com/sila-chain/sila-rsil-exex-examples).
...
| [DB over RPC](./rpc-db)                                             | Illustrates how to run a standalone RPC server over a Rsil database instance                    |

## Database

| Example                  | Description                                                     |
| ------------------------ | --------------------------------------------------------------- |
| [DB access](./db-access) | Illustrates how to access Rsil's database in a separate process |
