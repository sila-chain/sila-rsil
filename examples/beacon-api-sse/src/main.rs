...
//!
//! See also [sila-beacon-API eventstream](https://sila.github.io/beacon-APIs/#/Events/eventstream)
//!
//! Run with
//!
//! ```sh
...
fn main() {
    Cli::<SilaChainSpecParser, BeaconEventsConfig>::parse()
...
impl BeaconEventsConfig {
    ...
    pub fn events_url(&self) -> String {
        format!("{}/sil/v1/events", self.http_base_url())
    }
...
mod tests {
    ...
    #[test]
    fn parse_config() {
        let args = BeaconEventsConfig::try_parse_from(["rsil"]);
        assert!(args.is_ok());
    }
