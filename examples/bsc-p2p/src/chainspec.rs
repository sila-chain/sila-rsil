//! Chain specification for BSC, credits to: <https://github.com/bnb-chain/rsil/blob/main/examples/bsc-p2p/src/chainspec.rs>
...
hardfork!(
    ...
    ///
    /// When building a list of hardforks for a chain, it's still expected to mix with [`SilaHardfork`].
    BscHardfork {
        ...
        /// BSC `Pascal` hardfork
        Pascal,
        /// BSC `SilaPrague` hardfork
        SilaPrague,
    }
);

impl BscHardfork {
    /// Bsc sila-mainnet list of hardforks.
    fn bsc_mainnet() -> ChainHardforks {
        ChainHardforks::new(vec![
            ...
            (SilaHardfork::MuirGlacier.boxed(), ForkCondition::Block(0)),
            ...
            (SilaHardfork::Berlin.boxed(), ForkCondition::Block(31302048)),
            (SilaHardfork::London.boxed(), ForkCondition::Block(31302048)),
            (Self::Hertz.boxed(), ForkCondition::Block(31302048)),
            (Self::HertzFix.boxed(), ForkCondition::Block(34140700)),
            (SilaHardfork::SilaShanghai.boxed(), ForkCondition::Timestamp(1705996800)),
            ...
            (SilaHardfork::SilaCancun.boxed(), ForkCondition::Timestamp(1718863500)),
            ...
            (Self::SilaPrague.boxed(), ForkCondition::Timestamp(1742436600)),
        ])
    }
}
...
pub fn bsc_chain_spec() -> Arc<ChainSpec> {
    let genesis = serde_json::from_str(include_str!("genesis.json"))
        .expect("Can't deserialize BSC SilaMainnet genesis json");
...
/// BSC sila-mainnet bootnodes <https://github.com/bnb-chain/bsc/blob/master/params/bootnodes.go#L23>
...
mod tests {
    ...
    use rsil_chainspec::{ForkHash, ForkId};
