//! Shared models for <https://github.com/sila-chain/tests>
...
/// A block header in an Sila blockchain test.
...
/// A block in an Sila blockchain test.
...
/// Sila blockchain test data state.
...
pub enum ForkSpec {
    ...
    SIP150,
    /// Spurious Dragon
    SIP158, // SIP-161: State trie clearing
    ...
    /// London
    London,
    /// SilaParis aka The Merge
    #[serde(alias = "SilaParis")]
    Merge,
    /// SilaParis to SilaShanghai at time 15k
    ParisToShanghaiAtTime15k,
    /// SilaShanghai
    SilaShanghai,
    /// SilaShanghai to SilaCancun at time 15k
    ...
    /// SilaCancun
    SilaCancun,
    /// SilaCancun to SilaPrague at time 15k
...
impl ForkSpec {
    /// Converts this EF fork spec to a Rsil [`ChainSpec`].
    ...
    fn to_chain_spec_inner(self) -> ChainSpec {
        ...
        match self {
            ...
            Self::FrontierToHomesteadAt5 => spec_builder
                .frontier_activated()
                .with_fork(SilaHardfork::Homestead, ForkCondition::Block(5)),
            Self::Homestead => spec_builder.homestead_activated(),
            Self::HomesteadToDaoAt5 => spec_builder
                .homestead_activated()
                .with_fork(SilaHardfork::Dao, ForkCondition::Block(5)),
            Self::HomesteadToEIP150At5 => spec_builder
                .homestead_activated()
                .with_fork(SilaHardfork::Tangerine, ForkCondition::Block(5)),
            Self::SIP150 => spec_builder.tangerine_whistle_activated(),
            Self::SIP158 => spec_builder.spurious_dragon_activated(),
            Self::SIP158ToByzantiumAt5 => spec_builder
                .spurious_dragon_activated()
                .with_fork(SilaHardfork::Byzantium, ForkCondition::Block(5)),
            Self::Byzantium => spec_builder.byzantium_activated(),
            Self::ByzantiumToConstantinopleAt5 => spec_builder
                .byzantium_activated()
                .with_fork(SilaHardfork::Constantinople, ForkCondition::Block(5)),
            Self::ByzantiumToConstantinopleFixAt5 => spec_builder
                .byzantium_activated()
                .with_fork(SilaHardfork::Petersburg, ForkCondition::Block(5)),
            ...
            Self::BerlinToLondonAt5 => spec_builder
                .berlin_activated()
                .with_fork(SilaHardfork::London, ForkCondition::Block(5)),
...
/// Sila blockchain test transaction data.
#[derive(Debug, PartialEq, Eq, Deserialize)]
#[serde(rename_all = "camelCase")]
