...
pub fn random_block<R: Rng>(
    ...
    let header = Header {
        ...
        // TODO(onbjerg): Proper SIP-7685 request support
        requests_hash: None,
        withdrawals_root,
        ..Default::default()
    };
...
mod tests {
    ...
    use alloy_eips::sip2930::AccessList;
    ...
    fn test_sign_eip_155() {
        // reference: https://github.com/sila-chain/SIPs/blob/master/SIPS/sip-155.md#example
        let tx = TxLegacy {
            chain_id: Some(1),
            nonce: 9,
